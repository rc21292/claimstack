...
class DocumentReimbursementController extends Controller
{
    ...
    public function showDocument($id)
    {
        ...
        return view('hospital.claims.patients.tabs.view-document-reimbursement', compact('reimbursementdocument', 'patient', 'document_files'));
    }
    ...
    public function show($id)
    {
        ...
        return view('hospital.claims.claimants.edit.document-reimbursement', compact('reimbursementdocument', 'claimant'));
    }
