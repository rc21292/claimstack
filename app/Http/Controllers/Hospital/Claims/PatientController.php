...
class PatientController extends Controller
{
    ...
    public function documentsReimbursement(Request $request)
    {
        ...
        return view('hospital.claims.patients.documents-reimbursement',  compact('hospital_id', 'associates', 'hospitals', 'reimbursementdocument'));
    }
    ...
    public function saveDocumentsReimbursement(Request $request, $id)
    {
       ...
       $reimbursementdocument =  ReimbursementDocument::where('patient_id', 'P-10001')->update($request->except('_token','patient_id'));
        ...
        return view('hospital.claims.patients.documents-reimbursement',  compact('hospital_id', 'associates', 'hospitals'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hospital.patients.index')->with('success', 'Patient added successfully');
    }
