...
class ClaimantController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($filter_search) {
            $claimants->where('status', 1)->where('hospital_id', auth()->user()->id)->whereHas('patient', function ($q) use ($filter_search) {
        ...
        $claimants      = $claimants->where('status', 1)->where('hospital_id', auth()->user()->id)->orderBy('id', 'desc')->paginate(20);
    ...
    public function create(Request $request)
    {
        ...
        return view('hospital.claims.claimants.create.claimant', compact('claim', 'claims'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('hospital.claims.claimants.edit.claimant', compact('claimant', 'claims'));
    }
