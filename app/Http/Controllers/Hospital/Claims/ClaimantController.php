...
class ClaimantController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('hospital.claims.claimants.create.create',  compact('patient_id', 'associates', 'hospitals', 'patient', 'patients', 'claims', 'claim', 'claim_id', 'associate_partner_id', 'hospital_id', 'patient_title', 'patient_firstname', 'patient_lastname', 'patient_middlename', 'patient_id_proof'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hospital.claimants.edit',$claimant->id)->with('success', 'Claimant created successfully');
    ...
    public function edit($id)
    {
        ...
        return view('hospital.claims.claimants.edit.edit',  compact('patient_id', 'associates', 'hospitals', 'patient', 'claimant', 'borrower', 'id', 'claim'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('hospital.claimants.edit',$id)->with('success', 'Claimant updated successfully');
    }
    ...
    public function borrowerDetails(Request $request, $id)
    {
        ...
        return redirect()->route('hospital.claimants.index')->with('success', 'Borrower created successfully');
