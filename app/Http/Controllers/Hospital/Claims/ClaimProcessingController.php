...
class ClaimProcessingController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('hospital.claims.processing.create.create', compact('claim', 'claim_processing', 'insurers', 'icd_codes_level1', 'icd_codes_level2', 'icd_codes_level3', 'icd_codes_level4', 'pcs_group_name', 'pcs_sub_group_name', 'pcs_short_name' , 'pcs_codes', 'patient', 'hospital'));
    }
