...
class DischargeStatusController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('hospital.claims.discharges.create.create', compact('claim', 'discharge_status', 'insurers'));
    }
    ...
    public function show($id)
    {
        ...
        return view('hospital.claims.claimants.edit.discharge-status', compact('claimant', 'discharge_status', 'insurers'));
    }
