...
class HospitalController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('hospital.hospitals.create.create',  compact('associates', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hospital.hospitals.index')->with('success', 'Hospital created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'pollution_clearance_certificate_file' => ($request->onboarding == 'Tie Up' && $request->pollution_clearance_certificate != 'No') ? 'required' : [],
            'fire_safety_clearance_certificate' => ($request->onboarding == 'Tie Up') ? 'required' : [],
            'fire_safety_clearance_certificate_file' => ($request->onboarding == 'Tie Up' && $request->fire_safety_clearance_certificate != 'No') ? 'required' : [],
            'certificate_of_incorporation' => ($request->onboarding == 'Tie Up') ? 'required' : [],
            'certificate_of_incorporation_file' => ($request->onboarding == 'Tie Up' && $request->certificate_of_incorporation != 'No') ? 'required' : [],
    ...
    {        
        ...
        $rules = [
            ...
            'pharmacy_file'                     => ($hospital->onboarding == 'Tie Up' && $request->pharmacy == 'Yes') ? 'required' : [],
            'lab'                => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'lab_file'                => ($hospital->onboarding == 'Tie Up' && $request->lab == 'Yes') ? 'required' : [],
            'ambulance'               => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'ambulance_file'               => ($hospital->onboarding == 'Tie Up' && $request->ambulance == 'Yes') ? 'required' : [],
            'operation_theatre'                       => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'operation_theatre_file'                       => ($hospital->onboarding == 'Tie Up' && $request->operation_theatre == 'Yes') ? 'required' : [],
            'icu'                      => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'icu_file'                      => ($hospital->onboarding == 'Tie Up' && $request->icu == 'Yes') ? 'required' : [],
            'iccu'                   => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'iccu_file'                   => ($hospital->onboarding == 'Tie Up' && $request->iccu == 'Yes') ? 'required' : [],
            'nicu'                 => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'nicu_file'                 => ($hospital->onboarding == 'Tie Up' && $request->nicu == 'Yes') ? 'required' : [],
            'csc_sterilization'                    => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'csc_sterilization_file'                    => ($hospital->onboarding == 'Tie Up' && $request->csc_sterilization == 'Yes') ? 'required' : [],
            'centralized_gas_ons'                  => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'centralized_gas_ons_file'                  => ($hospital->onboarding == 'Tie Up' && $request->centralized_gas_ons == 'Yes') ? 'required' : [],
            'centralized_ac'                     => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'centralized_ac_file'                     => ($hospital->onboarding == 'Tie Up' && $request->centralized_ac == 'Yes') ? 'required' : [],
            'kitchen'                    => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'kitchen_file'                    => ($hospital->onboarding == 'Tie Up' && $request->kitchen == 'Yes') ? 'required' : [],
            'usg_machine'                  => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'usg_machine_file'                  => ($hospital->onboarding == 'Tie Up' && $request->usg_machine == 'Yes') ? 'required' : [],
            'digital_xray'                    => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'digital_xray_file'                    => ($hospital->onboarding == 'Tie Up' && $request->digital_xray == 'Yes') ? 'required' : [],
            'ct'     => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'ct_file'     => ($hospital->onboarding == 'Tie Up' && $request->ct == 'Yes') ? 'required' : [],
            'mri' => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'mri_file' => ($hospital->onboarding == 'Tie Up' && $request->mri == 'Yes') ? 'required' : [],
            'pet_scan' => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'pet_scan_file' => ($hospital->onboarding == 'Tie Up' && $request->pet_scan == 'Yes') ? 'required' : [],
            'organ_transplant_unit' => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'organ_transplant_unit_file' => ($hospital->onboarding == 'Tie Up' && $request->organ_transplant_unit == 'Yes') ? 'required' : [],
            'burn_unit' => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'burn_unit_file' => ($hospital->onboarding == 'Tie Up' && $request->burn_unit == 'Yes') ? 'required' : [],
            'dialysis_unit' => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'dialysis_unit_file' => ($hospital->onboarding == 'Tie Up' && $request->dialysis_unit == 'Yes') ? 'required' : [],
            'blood_bank' => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'blood_bank_file' => ($hospital->onboarding == 'Tie Up' && $request->blood_bank == 'Yes') ? 'required' : [],
    ...
    public function updateHospitalInfrastructure(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'nabh_status_file' => ($hospital->onboarding == 'Tie Up' && $request->nabh_status != 'NA') ? 'required' : [],
            'jci_status' => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'jci_status_file' => ($hospital->onboarding == 'Tie Up' && $request->jci_status != 'No') ? 'required' : [],
            'nqac_nhsrc_status' => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'nqac_nhsrc_status_file' => ($hospital->onboarding == 'Tie Up' && $request->nqac_nhsrc_status != 'NA') ? 'required' : [],
            'hippa_status' => ($hospital->onboarding == 'Tie Up') ? 'required' : [],
            'hippa_status_file' => ($hospital->onboarding == 'Tie Up' && $request->hippa_status != 'No') ? 'required' : [],
            'comments' => ($hospital->onboarding == 'Tie Up') ? 'required|string|max:250' : []
        ];
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('hospital.hospitals.index')->with('success', 'Hospital deleted successfully');
    }
}
