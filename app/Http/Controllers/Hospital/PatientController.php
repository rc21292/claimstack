...
class PatientController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('hospital.claims.create.patient',  compact('hospital_id','associates','hospital'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // $perm_user = Patient::find($patient->id);

        // $password = '12345678';
        // $patient->notify(new CredentialsGeneratedNotification($patient->email, $password, $patient));

        return redirect()->route('hospital.patients.index')->with('success', 'Patient created successfully');
    }
