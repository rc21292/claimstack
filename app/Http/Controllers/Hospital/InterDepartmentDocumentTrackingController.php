...
class InterDepartmentDocumentTrackingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('hospital.inter_department_document_trackings.manage',  compact('inter_department_document_trackings', 'filter_claim_id', 'filter_patient_id', 'filter_date_from_to'));
    }
    ...
    public function create()
    {
        ...
        $employees = Hospital::orderBy('id', 'desc')->get(['id', 'firstname', 'lastname', 'uid', 'employee_code', 'department']);
        ...
        return view('hospital.inter_department_document_trackings.create.create',  compact('claims', 'associate_partners', 'patients', 'hospitals', 'user', 'employees'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hospital.inter-department-docs-tracking.index')->with('success', 'Inter Department Document Tracking created successfully');          
    }
    ...
    public function show($id)
    {
        ...
        return view('hospital.inter_department_document_trackings.show',  compact('document_inward_outward_tracking'));
    }
    ...
    public function edit($id)
    {
        ...
        $associate_partners = AssociatePartner::orderBy('id', 'desc')->get(['id', 'name', 'associate_partner_id']);
        $hospitals = Hospital::orderBy('id', 'desc')->get(['id', 'name', 'uid']);
        return view('hospital.inter_department_document_trackings.edit.edit',  compact('claims', 'associate_partners', 'patients', 'hospitals', 'user', 'employees', 'document_inward_outward_tracking'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('hospital.inter-department-docs-tracking.index')->with('success', 'Inter Department Document Tracking updated successfully');          
