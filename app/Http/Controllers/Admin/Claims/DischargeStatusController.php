...
class DischargeStatusController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.claims.discharges.create.create', compact('claim', 'discharge_status', 'insurers'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.claims.claimants.edit.discharge-status', compact('claimant', 'discharge_status', 'insurers'));
    }
