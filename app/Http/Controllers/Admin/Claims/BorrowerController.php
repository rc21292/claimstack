...
class BorrowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.claims.borrowers.manage',  compact('borrowers', 'filter_search'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.claims.borrowers.create.create', compact('claimants', 'insurers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('admin.borrowers.index'))->with('success', 'Borrower Details created successfully');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.claims.claimants.edit.borrower', compact('claimant', 'borrower', 'insurers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.claims.borrowers.create', compact('claim', 'borrower', 'insurers', 'claimant'));
    }

    /**
     * Update the specified resource in storage.status
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
