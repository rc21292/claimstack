...
class LendingStatusController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.claims.lending.create.create', compact('assessment', 'lending_status', 'insurers', 'borrower', 'associates'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.claims.claimants.edit.lending-status', compact('claimant', 'assessment', 'lending_status', 'insurers', 'borrower', 'associates'));
    }
