...
class HospitalController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.hospitals.edit.edit',  compact('hospital', 'tpas','associates', 'hospitals', 'hospital_facility', 'hospital_nfrastructure', 'hospital_department', 'hospital_tie_ups', 'users', 'insurers', 'hospital_document', 'empanelment_status','empanelments'));
    }
