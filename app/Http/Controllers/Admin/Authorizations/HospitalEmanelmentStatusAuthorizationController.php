...
class HospitalEmanelmentStatusAuthorizationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $hospital_empanelments = $hospital_empanelments->where('status', 1)->whereHas('hospital' , function($query)
        {
        ...
        return view('admin.authorizations.hospitals.empanelments.manage',  compact('hospital_empanelments', 'filter_search'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.authorizations.hospitals.empanelments.show',  compact('hospital_empanelment'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.hospital-empstatus-authorizations.index')->with('success', 'Hospital Empanelment Status Authorised successfully');
    }
