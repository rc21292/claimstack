...
class AssigningStatusClaimProcessingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.assigning-status.processing.manage',  compact('claims', 'filter_search','filter_claim_id','filter_date_from_to','filter_status'));
    }
    ...
    {        
        ...
        return view('admin.assigning-status.processing.create',  compact('claim','insurers', 'admins'));
    }
