...
class DocumentInwardOutwardTrackingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.document_inward_outward_trackings.manage',  compact('document_inward_outward_trackings', 'filter_claim_id', 'filter_patient_id', 'filter_date_from_to'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.document_inward_outward_trackings.create.create',  compact('claims', 'associate_partners', 'patients', 'hospitals', 'user'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.document-inward-outward-tracking.index')->with('success', 'Document Inward Outward Tracking created successfully');          
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.document_inward_outward_trackings.show',  compact('document_inward_outward_tracking'));
    }
    ...
    public function edit($id)
    {
        ...
        $associate_partners = AssociatePartner::orderBy('id', 'desc')->get(['id', 'name', 'associate_partner_id']);
        $hospitals = Hospital::orderBy('id', 'desc')->get(['id', 'name', 'uid']);
        return view('admin.document_inward_outward_trackings.edit.edit',  compact('claims', 'associate_partners', 'patients', 'hospitals', 'user', 'document_inward_outward_tracking'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.document-inward-outward-tracking.index')->with('success', 'Document Inward Outward Tracking updated successfully');          
    }
