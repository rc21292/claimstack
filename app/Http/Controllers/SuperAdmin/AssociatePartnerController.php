...
class AssociatePartnerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('super-admin.associate-partners.manage',  compact('associates', 'filter_search'));
    }
    ...
    public function create()
    {
        ...
        return view('super-admin.associate-partners.create.create',  compact('associates', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('super-admin.associate-partners.index')->with('success', 'Associate partner created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        $associates         = AssociatePartner::get();
        $users              = User::get();
        return view('super-admin.associate-partners.edit.edit',  compact('associate', 'associates', 'users'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('super-admin.associate-partners.index')->with('success', 'Associate partner deleted successfully');
    }

    public function importExport(Request $request){
        return view('super-admin.associate-partners.import-export');
    }
