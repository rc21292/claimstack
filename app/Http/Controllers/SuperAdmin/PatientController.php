...
class PatientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('super-admin.patients.index')->with('success', 'Patient created successfully');
    }
...
'uid.unique'                   => 'This Employee Code is already taken.',
        ...
        return redirect()->route('super-admin.users.index')->with('success', 'Patient updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('super-admin.users.index')->with('success', 'Patient deleted successfully');
    }
