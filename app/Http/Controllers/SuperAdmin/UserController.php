...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('super-admin.users.manage',  compact('users', 'filter_search'));
    }
    ...
    public function create()
    {
        ...
        return view('super-admin.users.create.create',  compact('admins', 'users', 'permissions'));
    }
    ...
    public function edit($id)
    {
        ...
        $admins = Admin::orderBy('id', 'desc')->get(['id', 'firstname', 'lastname', 'employee_code', 'department']);
        $users  = User::orderBy('id', 'desc')->get(['id', 'firstname', 'lastname', 'employee_code','department']);
        return view('super-admin.users.edit.edit',  compact('admins', 'users', 'user', 'permissions'));
    }
    ...
    public function importExport(Request $request){
        return view('super-admin.users.import-export');
    }
