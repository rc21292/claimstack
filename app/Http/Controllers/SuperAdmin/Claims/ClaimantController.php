...
class ClaimantController extends Controller
{
    ...
    public function saveLendingStatus(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'time_of_loan_application'=> ($request->applyloan == 1) ? 'required':[],
            'loan_id_or_no'=> ($request->applyloan == 1) ? 'required|max:20': [],
            'loan_id_or_no_file' => ($request->applyloan == 1) ? 'required': [],
            ...
            'insurance_claim_settled_amount'=> ($request->applyloan == 1) ? 'digits_between:1,8':[],
            're_apply_loan_amount'=>($request->applyloan == 1) ? 'digits_between:1,8':[],
