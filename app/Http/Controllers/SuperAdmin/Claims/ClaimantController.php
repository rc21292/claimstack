...
class ClaimantController extends Controller
{
    ...
    public function saveDischargeStatus(Request $request,$id){
        ...
        $rules = [
            ...
            'injury_reason'          => 'required',
            'injury_due_to_substance_abuse_alcohol_consumption' => 'required',
            'if_medico_legal_case_mlc'           => 'required',
            'reported_to_police'                 => 'required',
            'mlc_report_and_police_fir_attached' => 'required',
            'fir_or_mlc_no'                      => 'required|max:60',
            'not_reported_to_police_reason'      => 'required',
            'maternity_date_of_delivery'         => 'required',
            'maternity_gravida_status_g'         => 'required',
            'maternity_gravida_status_p'         => 'required',
            'maternity_gravida_status_l'         => 'required',
            'maternity_gravida_status_a'         => 'required',
            'premature_baby'                     => 'required',
            'date_of_discharge'                  => 'required',
            'time_of_discharge'                  => 'required',
            'discharge_status'                   => 'required',
            'death_summary'                      => 'required',
            'discharge_status_comments'          => 'required|max:255',
            'injury_due_to_substance_abuse_alcohol_consumption_file'=>'required',
            'mlc_report_and_police_fir_attached'=>'required',
            'death_summary_file'=>'required'
        ...
        $messages = [
            ...
            'if_medico_legal_case_mlc.required'           => 'Please enter legal case',
            ...
            'discharge_status_comments'                   => 'Please enter discharge status comments',
