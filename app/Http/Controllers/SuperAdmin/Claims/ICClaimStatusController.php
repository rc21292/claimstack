...
class ICClaimStatusController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('super-admin.claims.ic_claims.create.create', compact('icclaim_status', 'insurers', 'claimant', 'associates'));
    }
    ...
    public function show($id)
    {
        ...
        return view('super-admin.claims.claimants.edit.ic_claims-status', compact('claimant', 'assessment', 'icclaim_status', 'insurers', 'claimant', 'associates'));
    }
