...
class ClaimController extends Controller
{
    ...
    public function updateInsurancePolicy(Request $request, $id)
    {
        $rules = [
            ...
            'group_name'                                => $request->policy_type == 'Group' ? 'required' : '',
            'start_date'                                => 'required',
            'expiry_date'                               => 'required',
            'commencement_date'                         => 'required',
            'proposer_title'                            => 'required',
            'proposer_firstname'                        => 'required',
            'proposer_middlename'                       => 'required',
            'proposer_lastname'                         => 'required',
            ...
            'insurance_company_other'                   => $request->currently_covered == 'Yes' ? 'required' : '',
            'policy_no_other'                           => $request->currently_covered == 'Yes' ? 'required' : '',
            'sum_insured_other'                         => $request->currently_covered == 'Yes' ? 'required' : '',
            'hospitalized'                              => 'required',
            'admission_date_past'                       => $request->hospitalized == 'Yes' ? 'required' : '',
            'diagnosis'                                 => $request->hospitalized == 'Yes' ? 'required' : '',
            'primary_insured_firstname'                 => 'required',
            'primary_insured_gender'                    => 'required',
            'primary_insured_age'                       => 'required',
            'primary_insured_relation'                  => 'required',
            'primary_insured_sum_insured'               => 'required',
            'primary_insured_cumulative_bonus'          => 'required',
            'primary_insured_balance_sum_insured'       => 'required',
            'dependent_insured_firstname'               => 'required',
            'dependent_insured_gender'                  => 'required',
            'dependent_insured_age'                     => 'required',
            'dependent_insured_relation'                => 'required',
            'dependent_insured_sum_insured'             => 'required',
            'dependent_insured_cumulative_bonus'        => 'required',
            'dependent_insured_balance_sum_insured'     => 'required',
        ];
