...
class AssociatePartnerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.associate-partners.manage',  compact('associates'));
    }
    ...
    public function create()
    {
        ...
        $users      = User::get();
        return view('employee.associate-partners.create.create',  compact('associates', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('employee.associate-partners.index')->with('success', 'Associate partner created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        $associates         = AssociatePartner::get();
        $users              = User::get();
        return view('employee.associate-partners.edit.edit',  compact('associate', 'associates', 'users'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('employee.associate-partners.index')->with('success', 'Associate partner deleted successfully');
    }
}
