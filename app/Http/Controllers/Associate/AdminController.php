...
class AdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('associate.admins.manage',  compact('admins', 'filter_search'));
    }
    ...
    public function create()
    {
        ...
        return view('associate.admins.create.create',  compact('admins', 'users', 'permissions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('associate-partner.admins.index')->with('success', 'Admin created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        $admins = Admin::orderBy('id', 'desc')->get(['id', 'firstname', 'lastname', 'employee_code', 'department']);
        $users  = User::orderBy('id', 'desc')->get(['id', 'firstname', 'lastname', 'employee_code', 'department']);
        return view('associate.admins.edit.edit',  compact('admins', 'users', 'admin', 'permissions'));
    }
...
'uid.unique'                   => 'This Employee Code is already taken.',
        ...
        return redirect()->route('associate-partner.admins.index')->with('success', 'Admin updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('associate-partner.admins.index')->with('success', 'Admin deleted successfully');
    }

    public function importExport(Request $request){
        return view('associate.admins.import-export');
    }
