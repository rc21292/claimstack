...
class ICClaimStatusController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('associate.claims.ic_claims.create.create', compact('icclaim_status', 'insurers', 'claimant', 'associates'));
    }
    ...
    public function show($id)
    {
        ...
        return view('associate.claims.claimants.edit.ic_claims-status', compact('claimant', 'assessment', 'icclaim_status', 'insurers', 'claimant', 'associates'));
    }
