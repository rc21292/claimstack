...
class ClaimantController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('associate.claims.claimants.manage',  compact('claimants', 'filter_search'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('associate.claims.claimants.create.claimant', compact('claim', 'claims'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('associate.claimants.edit', $claimant->id)->with('success', 'Claimant created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('associate.claims.claimants.edit.claimant', compact('claimant', 'claims'));
    }
