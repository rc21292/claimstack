...
class BorrowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('associate.claims.borrowers.manage',  compact('borrowers', 'filter_search'));
    }
    ...
    public function create()
    {
        ...
        return view('associate.claims.borrowers.create.create', compact('claimants', 'insurers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('associate.borrowers.index'))->with('success', 'Borrower Details created successfully');
    }
    ...
    public function show($id)
    {
        ...
        return view('associate.claims.claimants.edit.borrower', compact('claimant', 'borrower', 'insurers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('associate.claims.borrowers.create', compact('claim', 'borrower', 'insurers', 'claimant'));
    }
