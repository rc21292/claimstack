...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('associate.users.manage',  compact('users', 'filter_search'));
    }
    ...
    public function create()
    {
        ...
        return view('associate.users.create.create',  compact('admins', 'users', 'permissions'));
    }
...
'uid.unique'                   => 'This Employee Code is already taken.',
    ...
    public function edit($id)
    {
        ...
        $admins = Admin::orderBy('id', 'desc')->get(['id', 'firstname', 'lastname', 'employee_code', 'department']);
        $users  = User::orderBy('id', 'desc')->get(['id', 'firstname', 'lastname', 'employee_code','department']);
        return view('associate.users.edit.edit',  compact('admins', 'users', 'user', 'permissions'));
    }
...
'uid.unique'                   => 'This Employee Code is already taken.',
    ...
    public function importExport(Request $request){
        return view('associate.users.import-export');
    }
