...
class AssociatePartnerController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('associate.associate-partners.create.create',  compact('associates', 'users'));
    }
    ...
    {
        $associate = AssociatePartner::find($id);
        return view('associate.associate-partners.view.show',  compact('associate'));
    }
    ...
    public function importExport(Request $request){
        return view('associate.associate-partners.import-export');
    }
