...
class CredentialsGeneratedNotification extends Notification
{
     ...
     * @return void
     */
    public function __construct($email, $password, $hospital)
    {
        $this->email = $email;
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->greeting(Lang::get('Hello '.$this->hospital->firstname.' '.$this->hospital->lastname.'!'))
    ...
    {       
        return url(route('hospital.login'));
    }
