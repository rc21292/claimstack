...
namespace App\Notifications\Associate;
...
class CredentialsGeneratedNotification extends Notification
{
     ...
     * @return void
     */
    public function __construct($email, $password, $associate)
    {
        $this->email = $email;
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->greeting(Lang::get('Hello '.$this->associate->firstname.' '.$this->associate->lastname.'!'))
    ...
    {       
        return url(route('associate-partner.login'));
    }
