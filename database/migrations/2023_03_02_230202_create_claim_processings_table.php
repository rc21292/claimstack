...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('claim_processings', function (Blueprint $table) {
            ...
            $table->string('date_time_of_admission')->nullable();
            ...
            $table->string('date_of_injury_or_disease_first_detected_or_delivery')->nullable();
            ...
            $table->string('treatment_category_propose_line_of_treatment')->nullable();
            $table->string('disease_category')->nullable();
            $table->string('disease_name')->nullable();
            $table->string('disease_type')->nullable();
            $table->string('nature_of_illnessordisease_with_presenting_complaints')->nullable();
            ...
            $table->text('procedurei_pcs_group_name')->nullable();
            $table->text('procedurei_pcs_group_code')->nullable();
            $table->text('procedurei_pcs_sub_group_name')->nullable();
            $table->text('procedurei_pcs_sub_group_code')->nullable();
            $table->text('procedurei_pcs_short_name')->nullable();
            $table->text('procedurei_pcs_code')->nullable();
            $table->text('procedurei_pcs_long_name')->nullable();
