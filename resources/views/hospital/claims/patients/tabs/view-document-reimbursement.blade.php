                    ...
                    <div class="card-body p-0" >
                        <div class="" style="background:#3E4097">
                            ...
                            <div class="col-12 nav nav-tabs" id="myTab" style="font-size: 17px;" >
                                <a class="text-white px-1 active" href="#tab1" c data-bs-toggle="tab">Pre-Assessment Documents</a>
                                <a class="text-white px-1" href="#tab2" data-bs-toggle="tab">Final Assessment Documents</a>
                                <a class="text-white px-1" href="#tab3" data-bs-toggle="tab">Insurance Claim Documents</a>
                                <a class="text-white px-1" href="#tab6" data-bs-toggle="tab">Insurance Settlement Documents</a>
                                <a class="text-white px-1" href="#tab4" data-bs-toggle="tab">Medical Loan (Borrower) Documents</a>
                                <a class="text-white px-1" href="#tab5" data-bs-toggle="tab">Loan (Co-Borrower) Documents</a>
                                <a class="text-white px-1" href="#tab7" data-bs-toggle="tab">Lending Status Documents</a>
                            </div>
                        </div>
