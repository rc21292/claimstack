        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills  bg-nav-pills  nav-justified mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('hospital.assessment-status.show', $claimant->id) }}" aria-expanded="true"
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="assessment_status_tab">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('hospital.assessment-status.update', $claimant->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input type="text" readonly class="form-control" id="hospital_id"
                                                ...
                                                value="{{ old('hospital_id', @$claimant->patient->hospital->uid) }}">
                                            @error('hospital_id')
                                                <span id="name-error"
                                                    class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input type="text" readonly class="form-control" id="hospital_name"
                                                ...
                                                value="{{ old('hospital_name', @$claimant->patient->hospital->name) }}">
                                            @error('hospital_name')
                                                <span id="name-error"
                                                    class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <input type="text" readonly class="form-control" id="hospital_address"
                                                ...
                                                value="{{ old('hospital_address', @$claimant->patient->hospital->address) }}">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <input type="text" readonly class="form-control" id="hospital_city"
                                                ...
                                                value="{{ old('hospital_city', @$claimant->patient->hospital->city) }}">
                                            @error('hospital_city')
                                                <span id="name-error"
                                                    class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <input type="text" readonly class="form-control" id="hospital_state"
                                                ...
                                                value="{{ old('hospital_state', @$claimant->patient->hospital->state) }}">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <input type="number" readonly class="form-control" id="hospital_pincode"
                                                ...
                                                value="{{ old('hospital_pincode', @$claimant->patient->hospital->pincode) }}">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <select class="form-control" disabled id="patient_title" name="patient_title">
                                                <option disabled value="">Select</option>
                                                <option disabled @if (old('patient_title', @$claimant->patient->title) == 'Mr.') selected @endif
                                                    value="Mr.">Mr.</option>
                                                <option disabled @if (old('patient_title', @$claimant->patient->title) == 'Ms.') selected @endif
                                                    value="Ms.">Ms.</option>
                                            </select>
                                            @error('patient_title')
                                                <span id="name-error"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="text" readonly maxlength="16" class="form-control"
                                                ...
                                                value="{{ old('policy_no', @$claimant->claim->policy->policy_no) }}">
                                            @error('policy_no')
                                                <span id="name-error"
                                                    class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                            ...
                                            <select class="form-control select2" disabled id="insurance_company"
                                                ...
                                                @foreach ($insurers as $insurer)
                                                    <option value="{{ $insurer->id }}"
                                                        {{ old('insurance_company', @$claimant->claim->policy->insurer_id) == $insurer->id ? 'selected' : '' }}>
                                                        {{ $insurer->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="text" readonly maxlength="16" class="form-control"
                                                ...
                                                value="{{ old('company_tpa_id_card_no', @$claimant->claim->policy->company_tpa_id_card_no) }}">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <select class="form-control" disabled id="hospital_on_the_panel_of_insurance_co"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="pre_assessment_amount">Pre-Assessment Amount <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" readonly maxlength="8" onkeypress="return isNumberKey(event)"  placeholder="Enter Pre-Assessment Amount"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <select disabled class="form-select pre_assessment_suspected_fraud"
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <textarea readonly class="form-control" id="pre_assessment_status_comments" name="pre_assessment_status_comments"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="final_assessment_amount">Final Assessment Amount <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" maxlength="8" onkeypress="return isNumberKey(event)" placeholder="Enter Final Assessment Amount" readonly 
