                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('hospital.claimants.index') }}">Leanding Status</a>
                            </li>
        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills  bg-nav-pills  nav-justified mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('hospital.lending-status.show', $claimant->id) }}" aria-expanded="true"
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="lending_status_tab">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('hospital.lending-status.update', $claimant->id) }}"
