        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills  bg-nav-pills  nav-justified mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('hospital.claim-processing.show', $claimant->id) }}" aria-expanded="true"
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="claim_processing_tab">
                        ...
                        <form action="{{ route('hospital.claim-processing.update', $claimant->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input readonly type="text" maxlength="100" class="form-control" id="procedure_name" name="procedure_name"
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <select disabled class="form-select" id="final_assessment_status" name="final_assessment_status">
