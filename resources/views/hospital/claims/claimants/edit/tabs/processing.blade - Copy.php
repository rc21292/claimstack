...
$claim_processing = ClaimProcessing::where('patient_id', $patient->uid)->first();
echo $claim_processing->primary_diagnosis_icd_leveliii_disease;
@endphp

<form action="{{ route('hospital.claims.processing') }}" method="post" id="claim-processing-form" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group row">
       ...
       <div class="col-md-6 mb-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="primary_diagnosis_icd_leveli_disease" name="primary_diagnosis_icd_leveli_disease">
                ...
                @foreach ($icd_codes_level1 as $icd_code)
                    <option value="{{ $icd_code->level1 }}"
                        {{ old('primary_diagnosis_icd_leveli_disease', $claim_processing->primary_diagnosis_icd_leveli_disease) == $icd_code->level1 ? 'selected' : '' }}
        ...
        <div class="col-md-6 mt-3">
            ...
            <input type="text" maxlength="16" class="form-control" id="primary_diagnosis_icd_leveli_code" name="primary_diagnosis_icd_leveli_code" placeholder="Enter ICD - Level - I - Code" value="{{ old('primary_diagnosis_icd_leveli_code', $claim_processing->primary_diagnosis_icd_leveli_code) }}">
            ...
            <select class="form-control select2" data-toggle="select2" id="primary_diagnosis_icd_levelii_disease" name="primary_diagnosis_icd_levelii_disease">
                ...
                @foreach ($icd_codes_level2 as $icd_code)
                    <option value="{{ $icd_code->level2 }}"
                        {{ old('primary_diagnosis_icd_levelii_disease', $claim_processing->primary_diagnosis_icd_levelii_disease) == $icd_code->level2 ? 'selected' : '' }}
        ...
        <div class="col-md-6 mt-3">
            ...
            <input type="text" maxlength="16" class="form-control" id="primary_diagnosis_icd_levelii_code" name="primary_diagnosis_icd_levelii_code"  placeholder="Enter ICD - Level - II - Code" value="{{ old('primary_diagnosis_icd_levelii_code', $claim_processing->primary_diagnosis_icd_levelii_code) }}">
        ...
        <div class="col-md-6 mt-3">
            <label for="primary_diagnosis_icd_leveliii_disease">ICD - Level - III - Disease {{ $claim_processing->primary_diagnosis_icd_leveliii_disease }} {{ old('primary_diagnosis_icd_leveliii_disease') }} <span class="text-danger">*</span></label>
            ...
            <select class="form-control select2" data-toggle="select2" id="primary_diagnosis_icd_leveliii_disease" name="primary_diagnosis_icd_leveliii_disease">
                ...
                @foreach ($icd_codes_level3 as $icd_code)
                    <option value="{{ $icd_code->level3 }}"
                        {{ old('primary_diagnosis_icd_leveliii_disease', $claim_processing->primary_diagnosis_icd_leveliii_disease) == trim($icd_code->level3) ? 'selected' : '' }}
        ...
        <div class="col-md-6 mt-3">
            ...
            <input type="text" maxlength="16" class="form-control" id="primary_diagnosis_icd_leveliii_code" name="primary_diagnosis_icd_leveliii_code"  placeholder="Enter ICD - Level - III - Code" value="{{ old('primary_diagnosis_icd_leveliii_code', $claim_processing->primary_diagnosis_icd_leveliii_code) }}">
            ...
            <select class="form-control select2" data-toggle="select2" id="primary_diagnosis_icd_leveliv_disease" name="primary_diagnosis_icd_leveliv_disease">
                ...
                @foreach ($icd_codes_level4 as $icd_code)
                    <option value="{{ $icd_code->level4 }}"
                        {{ old('primary_diagnosis_icd_leveliv_disease', $claim_processing->primary_diagnosis_icd_leveliv_disease) == $icd_code->level4 ? 'selected' : '' }}
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter ICD - Level - IV - Code" value="{{ old('primary_diagnosis_icd_leveliv_code', $claim_processing->primary_diagnosis_icd_leveliv_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="additional_diagnosis_icd_leveli_disease" name="additional_diagnosis_icd_leveli_disease">
                ...
                @foreach ($icd_codes_level1 as $icd_code)
                    <option value="{{ $icd_code->level1 }}"
                        {{ old('additional_diagnosis_icd_leveli_disease', $claim_processing->additional_diagnosis_icd_leveli_disease) == $icd_code->level1 ? 'selected' : '' }}
                        data-code="{{ $icd_code->level1_code }}">
                        {{ $icd_code->level1 }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter ICD - Level - I - Code" value="{{ old('additional_diagnosis_icd_leveli_code', $claim_processing->additional_diagnosis_icd_leveli_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="additional_diagnosis_icd_levelii_disease" name="additional_diagnosis_icd_levelii_disease">
                ...
                @foreach ($icd_codes_level2 as $icd_code)
                    <option value="{{ $icd_code->level2 }}"
                        {{ old('additional_diagnosis_icd_levelii_disease', $claim_processing->additional_diagnosis_icd_levelii_disease) == $icd_code->level2 ? 'selected' : '' }}
                        data-code="{{ $icd_code->level2_code }}">
                        {{ $icd_code->level2 }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            <input type="text" maxlength="16" class="form-control" id="additional_diagnosis_icd_levelii_code" name="additional_diagnosis_icd_levelii_code"  placeholder="Enter ICD - Level - II - Code" value="{{ old('additional_diagnosis_icd_levelii_code', $claim_processing->additional_diagnosis_icd_levelii_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="additional_diagnosis_icd_leveliii_disease" name="additional_diagnosis_icd_leveliii_disease">
                ...
                @foreach ($icd_codes_level3 as $icd_code)
                    <option value="{{ $icd_code->level3 }}"
                        {{ old('additional_diagnosis_icd_leveliii_disease', $claim_processing->additional_diagnosis_icd_leveliii_disease) == trim($icd_code->level3) ? 'selected' : '' }}
                        data-code="{{ $icd_code->level3_code }}">
                        {{ $icd_code->level3 }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            <input type="text" maxlength="16" class="form-control" id="additional_diagnosis_icd_leveliii_code" name="additional_diagnosis_icd_leveliii_code"  placeholder="Enter ICD - Level - III - Code" value="{{ old('additional_diagnosis_icd_leveliii_code', $claim_processing->additional_diagnosis_icd_leveliii_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="additional_diagnosis_icd_leveliv_disease" name="additional_diagnosis_icd_leveliv_disease">
                ...
                @foreach ($icd_codes_level4 as $icd_code)
                    <option value="{{ $icd_code->level4 }}"
                        {{ old('additional_diagnosis_icd_leveliv_disease', $claim_processing->additional_diagnosis_icd_leveliv_disease) == $icd_code->level4 ? 'selected' : '' }}
                        data-code="{{ $icd_code->level4_code }}">
                        {{ $icd_code->level4 }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            <input type="text" maxlength="16" class="form-control" id="additional_diagnosis_icd_leveliv_code" name="additional_diagnosis_icd_leveliv_code"  placeholder="Enter ICD - Level - IV - Code" value="{{ old('additional_diagnosis_icd_leveliv_code', $claim_processing->additional_diagnosis_icd_leveliv_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="co_morbidities_icd_leveli_disease" name="co_morbidities_icd_leveli_disease">
                ...
                @foreach ($icd_codes_level1 as $icd_code)
                    <option value="{{ $icd_code->level1 }}"
                        {{ old('co_morbidities_icd_leveli_disease', $claim_processing->co_morbidities_icd_leveli_disease) == $icd_code->level1 ? 'selected' : '' }}
                        data-code="{{ $icd_code->level1_code }}">
                        {{ $icd_code->level1 }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter ICD - Level - I - Code" value="{{ old('co_morbidities_icd_leveli_code', $claim_processing->co_morbidities_icd_leveli_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="co_morbidities_icd_levelii_disease" name="co_morbidities_icd_levelii_disease">
                ...
                @foreach ($icd_codes_level2 as $icd_code)
                    <option value="{{ $icd_code->level2 }}"
                        {{ old('co_morbidities_icd_levelii_disease', $claim_processing->co_morbidities_icd_levelii_disease) == $icd_code->level2 ? 'selected' : '' }}
                        data-code="{{ $icd_code->level2_code }}">
                        {{ $icd_code->level2 }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter ICD - Level - II - Code" value="{{ old('co_morbidities_icd_levelii_code', $claim_processing->co_morbidities_icd_levelii_code) }}">
        ...
        <div class="col-md-6 mt-3">
           ...
           <select class="form-control select2" data-toggle="select2" id="co_morbidities_icd_leveliii_disease" name="co_morbidities_icd_leveliii_disease">
                ...
                @foreach ($icd_codes_level3 as $icd_code)
                    <option value="{{ $icd_code->level3 }}"
                        {{ old('co_morbidities_icd_leveliii_disease', $claim_processing->co_morbidities_icd_leveliii_disease) == trim($icd_code->level3) ? 'selected' : '' }}
                        data-code="{{ $icd_code->level3_code }}">
                        {{ $icd_code->level3 }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter ICD - Level - III - Code" value="{{ old('co_morbidities_icd_leveliii_code', $claim_processing->co_morbidities_icd_leveliii_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="co_morbidities_icd_leveliv_disease" name="co_morbidities_icd_leveliv_disease">
                ...
                @foreach ($icd_codes_level4 as $icd_code)
                    <option value="{{ $icd_code->level4 }}"
                        {{ old('co_morbidities_icd_leveliv_disease', $claim_processing->co_morbidities_icd_leveliv_disease) == $icd_code->level4 ? 'selected' : '' }}
                        data-code="{{ $icd_code->level4_code }}">
                        {{ $icd_code->level4 }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter ICD - Level - IV - Code" value="{{ old('co_morbidities_icd_leveliv_code', $claim_processing->co_morbidities_icd_leveliv_code) }}">
        ...
        <div class="col-md-12 mt-3">
            ...
            <textarea class="form-control" id="co_morbidities_comments" name="co_morbidities_comments" maxlength="250" placeholder="Comments"  rows="5">{{ old('co_morbidities_comments', $claim_processing->co_morbidities_comments) }}</textarea>
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter Procedure Name" value="{{ old('procedure_name', $claim_processing->procedure_name) }}">
            ...
            <select class="form-control select2" data-toggle="select2" id="procedure_i_pcs_group_name" name="procedure_i_pcs_group_name">
                ...
                @foreach ($pcs_group_name as $pcs_group)
                    <option value="{{ $pcs_group->pcs_group_name }}"
                        {{ old('procedure_i_pcs_group_name', $claim_processing->procedure_i_pcs_group_name) == $pcs_group->pcs_group_name ? 'selected' : '' }}
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter PCS Group - Code" value="{{ old('procedure_i_pcs_group_code', $claim_processing->procedure_i_pcs_group_code) }}">
            ...
            <select class="form-control select2" data-toggle="select2" id="procedure_i_pcs_sub_group_name" name="procedure_i_pcs_sub_group_name">
                ...
                @foreach ($pcs_sub_group_name as $pcs_group)
                    <option value="{{ $pcs_group->pcs_sub_group_name }}"
                        {{ old('procedure_i_pcs_sub_group_name', $claim_processing->procedure_i_pcs_sub_group_name) == $pcs_group->pcs_sub_group_name ? 'selected' : '' }}
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter PCS Group - Code" value="{{ old('procedure_i_pcs_sub_group_code', $claim_processing->procedure_i_pcs_sub_group_code) }}">
            ...
            <select class="form-control select2" data-toggle="select2" id="procedure_i_pcs_short_name" name="procedure_i_pcs_short_name">
                ...
                @foreach ($pcs_short_name as $pcs_group)
                    <option value="{{ $pcs_group->pcs_short_name }}"
                        {{ old('procedure_i_pcs_short_name', $claim_processing->procedure_i_pcs_short_name) == $pcs_group->pcs_short_name ? 'selected' : '' }}
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter PCS Code" value="{{ old('procedure_i_pcs_code', $claim_processing->procedure_i_pcs_code) }}">
        ...
        <div class="col-md-12 mt-3">
            ...
            placeholder="Enter PCS Long Name" value="{{ old('procedure_i_pcs_long_name', $claim_processing->procedure_i_pcs_long_name) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="procedure_ii_pcs_group_name" name="procedure_ii_pcs_group_name">
                ...
                @foreach ($pcs_group_name as $pcs_group)
                    <option value="{{ $pcs_group->pcs_group_name }}"
                        {{ old('procedure_ii_pcs_group_name', $claim_processing->procedure_ii_pcs_group_name) == $pcs_group->pcs_group_name ? 'selected' : '' }}
                        data-code="{{ $pcs_group->pcs_group_code }}">
                        {{ $pcs_group->pcs_group_name }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter PCS Group - Code" value="{{ old('procedure_ii_pcs_group_code', $claim_processing->procedure_ii_pcs_group_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="procedure_ii_pcs_sub_group_name" name="procedure_ii_pcs_sub_group_name">
                ...
                @foreach ($pcs_sub_group_name as $pcs_group)
                    <option value="{{ $pcs_group->pcs_sub_group_name }}"
                        {{ old('procedure_ii_pcs_sub_group_name', $claim_processing->procedure_ii_pcs_sub_group_name) == $pcs_group->pcs_sub_group_name ? 'selected' : '' }}
                        data-code="{{ $pcs_group->pcs_sub_group_code }}">
                        {{ $pcs_group->pcs_sub_group_name }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter PCS Sub-Group - Code " value="{{ old('procedure_ii_pcs_sub_group_code', $claim_processing->procedure_ii_pcs_sub_group_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="procedure_ii_pcs_short_name" name="procedure_ii_pcs_short_name">
                ...
                @foreach ($pcs_short_name as $pcs_group)
                    <option value="{{ $pcs_group->pcs_short_name }}"
                        {{ old('procedure_ii_pcs_short_name', $claim_processing->procedure_ii_pcs_short_name) == $pcs_group->pcs_short_name ? 'selected' : '' }}
                        data-code="{{ $pcs_group->pcs_code }}" data-long_name="{{ $pcs_group->pcs_long_name }}">
                        {{ $pcs_group->pcs_short_name }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter PCS Code " value="{{ old('procedure_ii_pcs_code', $claim_processing->procedure_ii_pcs_code) }}">
        ...
        <div class="col-md-12 mt-3">
            ...
            placeholder="Enter PCS Long Name" value="{{ old('procedure_ii_pcs_long_name', $claim_processing->procedure_ii_pcs_long_name) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="procedure_iii_pcs_group_name" name="procedure_iii_pcs_group_name">
                ...
                @foreach ($pcs_group_name as $pcs_group)
                    <option value="{{ $pcs_group->pcs_group_name }}"
                        {{ old('procedure_iii_pcs_group_name', $claim_processing->procedure_iii_pcs_group_name) == $pcs_group->pcs_group_name ? 'selected' : '' }}
                        data-code="{{ $pcs_group->pcs_group_code }}">
                        {{ $pcs_group->pcs_group_name }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter PCS Group - Code" value="{{ old('procedure_iii_pcs_group_code', $claim_processing->procedure_iii_pcs_group_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="procedure_iii_pcs_sub_group_name" name="procedure_iii_pcs_sub_group_name">
                ...
                @foreach ($pcs_sub_group_name as $pcs_group)
                    <option value="{{ $pcs_group->pcs_sub_group_name }}"
                        {{ old('procedure_iii_pcs_sub_group_name', $claim_processing->procedure_iii_pcs_sub_group_name) == $pcs_group->pcs_sub_group_name ? 'selected' : '' }}
                        data-code="{{ $pcs_group->pcs_sub_group_code }}">
                        {{ $pcs_group->pcs_sub_group_name }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter PCS Sub-Group - Code" value="{{ old('procedure_iii_pcs_sub_group_code', $claim_processing->procedure_iii_pcs_sub_group_code) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2" data-toggle="select2" id="procedure_iii_pcs_short_name" name="procedure_iii_pcs_short_name">
                ...
                @foreach ($pcs_short_name as $pcs_group)
                    <option value="{{ $pcs_group->pcs_short_name }}"
                        {{ old('procedure_iii_pcs_short_name', $claim_processing->procedure_iii_pcs_short_name) == $pcs_group->pcs_short_name ? 'selected' : '' }}
                        data-code="{{ $pcs_group->pcs_code }}" data-long_name="{{ $pcs_group->pcs_long_name }}">
                        {{ $pcs_group->pcs_short_name }}
                    </option>
                @endforeach
        ...
        <div class="col-md-6 mt-3">
            ...
            placeholder="Enter PCS Code" value="{{ old('procedure_iii_pcs_code', $claim_processing->procedure_iii_pcs_code) }}">
        ...
        <div class="col-md-12 mt-3">
            ...
            placeholder="Enter PCS Long Name" value="{{ old('procedure_iii_pcs_long_name', $claim_processing->procedure_iii_pcs_long_name) }}">
        ...
        <div class="col-md-12 mt-3">
            ...
            <select class="form-select" id="final_assessment_status" name="final_assessment_status">
                <option value="Waiting for Final Assessment" {{ old('final_assessment_status', $claim_processing->final_assessment_status) == 'Waiting for Final Assessment' ? 'selected' : '' }}>Waiting for Final Assessment </option>
                <option value="Query Raised by BHC Team" {{ old('final_assessment_status', $claim_processing->final_assessment_status) == 'Query Raised by BHC Team' ? 'selected' : '' }}>Query Raised by BHC Team </option>
                <option value="Non Admissible as per the Policy TC" {{ old('final_assessment_status', $claim_processing->final_assessment_status) == 'Non Admissible as per the Policy TC' ? 'selected' : '' }}>Non Admissible as per the Policy TC </option>
                <option value="Non Admissible as per the Treatment Received" {{ old('final_assessment_status', $claim_processing->final_assessment_status) == 'Non Admissible as per the Treatment Received' ? 'selected' : '' }}>Non Admissible as per the Treatment Received </option>
                <option value="Admissible" {{ old('final_assessment_status', $claim_processing->final_assessment_status) == 'Admissible' ? 'selected' : '' }}>Admissible </option>
            </select>
        ...
        <div class="col-md-6 mt-3">
            ...
            value="{{ old('processing_query', $claim_processing->processing_query) }}">
        ...
        <div class="col-md-6 mt-3">
            ...
            value="{{ old('final_assessment_amount', $claim_processing->final_assessment_amount) }}">
        ...
        <div class="col-md-12 mt-3">
            ...
            <textarea readonly class="form-control" id="final_assessment_comments" name="final_assessment_comments" maxlength="250" placeholder="Comments"  rows="5">{{ old('final_assessment_comments', $claim_processing->final_assessment_comments) }}</textarea>
