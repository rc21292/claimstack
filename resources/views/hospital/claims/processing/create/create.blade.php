                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('hospital.claimants.index') }}">Claim Processing</a>
                            </li>
            ...
            <div class="col-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="claim_processing_tab">
                        ...
                        <form action="{{ route('hospital.claim-processing.claim-processing-update', $claim->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <textarea readonly class="form-control" id="co_morbidities_comments" name="co_morbidities_comments" maxlength="1000" placeholder="Comments"  rows="5">{{ old('co_morbidities_comments', isset($claim_processing) ? $claim_processing->co_morbidities_comments : '') }}</textarea>
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <textarea disabled class="form-control" id="final_assessment_comments" name="final_assessment_comments" maxlength="1000" placeholder="Enter Final Assessment Comments"  rows="5">{{ old('final_assessment_comments', isset($claim_processing) ? $claim_processing->final_assessment_comments : '') }}</textarea>
