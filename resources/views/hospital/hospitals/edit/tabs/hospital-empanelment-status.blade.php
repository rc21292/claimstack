...
<form action="{{ route('hospital.hospitals.empanelment-status', $hospital->id) }}" method="post" id="hospital-empanelment-form"
        enctype="multipart/form-data">
        @csrf
        @method('PUT')
    <input type="hidden" name="company_id" value="{{ request()->company_id }}">
        @else
        <form action="{{ route('hospital.hospitals.empanelment-status-store') }}" method="post" id="hospital-empanelment-form"
        enctype="multipart/form-data">
        @csrf
        @method('POST')
        @endif
        ...
        <div class="form-group row">
            <div class="col-md-12">
                <a href="{{ route('hospital.hospitals.edit', $hospital->id) }}?show=1"> <button style="float:right;" type="button" class="btn btn-danger show-empanelment"> <i class="mdi mdi-plus"></i> Add Insurance Co. / TPA / Other </button></a>
            </div>
 ...
 <input type="hidden" name="company_id" value="{{ request()->company_id }}">
        ...
        <div class="form-group row">
            ...
            {{-- <div class="col-md-12 show-hide-empanelment mt-3">
                ...
                <div class="col-md-12 show-hide-empanelment mt-3">
                    ...
                    <textarea readonly class="form-control" id="hospital_empanelment_status_comments" name="hospital_empanelment_status_comments" maxlength="1000" placeholder="Comments" rows="4">{{ old('hospital_empanelment_status_comments',isset($empanelment_status) ? $empanelment_status->hospital_empanelment_status_comments : ''??'') }}</textarea>
        ...
        <div>
            @include('hospital.hospitals.edit.tabs.hospital-empanelment-status-manage')
        </div>
    </div>
    @push('scripts')
    <script>
