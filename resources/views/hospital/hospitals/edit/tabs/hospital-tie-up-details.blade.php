<form action="{{ route('hospital.hospitals.tie-ups', $hospital->id) }}" method="post" id="hospital-tie-up-form"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-12 mt-3">
            ...
            <textarea readonly class="form-control" id="comments" name="comments" maxlength="1000" placeholder="Comments" rows="4">{{ old('comments', $hospital_tie_ups->comments??'') }}</textarea>
            @error('comments')
                <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
