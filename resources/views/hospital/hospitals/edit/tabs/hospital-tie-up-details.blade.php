<form action="{{ route('hospital.hospitals.tie-ups', $hospital->id) }}" method="post" id="hospital-tie-up-form"
    ...
    <div class="form-group row">
        <div class="col-md-12 mt-3">
            ...
            <input type="date" readonly class="form-control" @if($hospital->signed_mous == 'No') readonly @endif id="mou_inception_date" name="mou_inception_date"
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-select" id="bhc_packages_for_surgical_procedures_accepted" name="bhc_packages_for_surgical_procedures_accepted">
                ...
                <option disabled value="Yes" {{ old('bhc_packages_for_surgical_procedures_accepted', $hospital_tie_ups->bhc_packages_for_surgical_procedures_accepted ?? '') == 'Yes' ? 'selected' : '' }}>Yes
                </option>
            ...
            @endisset
            <input type="file" disabled name="bhc_packages_for_surgical_procedures_accepted_file" @if(old('bhc_packages_for_surgical_procedures_accepted',$hospital_tie_ups->bhc_packages_for_surgical_procedures_accepted) == 'No') disabled @endif id="bhc_packages_for_surgical_procedures_accepted_file" hidden />
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-select" id="discount_on_medical_management_cases" name="discount_on_medical_management_cases">
                <option value="">Select</option>
                <option disabled value="Yes" {{ old('discount_on_medical_management_cases', $hospital_tie_ups->discount_on_medical_management_cases?? '') == 'Yes' ? 'selected' : '' }}>Yes</option>
                <option disabled value="No" {{ old('discount_on_medical_management_cases', $hospital_tie_ups->discount_on_medical_management_cases?? '') == 'No' ? 'selected' : '' }}>No</option>
            </select>
        ...
        <div class="col-md-6 mt-3 show-hide-field">
            ...
            <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>1) return false;" class="form-control" id="discount_on_final_bill" name="discount_on_final_bill"
        ...
        <div class="col-md-6 mt-3 show-hide-field">
            <label for="discount_on_room_rent">Discount on room rent % <span
                    class="text-danger">*</span></label>
            <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>1) return false;" class="form-control" id="discount_on_room_rent" name="discount_on_room_rent"
        ...
        <div class="col-md-6 mt-3 show-hide-field">
            <label for="discount_on_medicines">Discount on medicines % <span
                    class="text-danger">*</span></label>
            <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>1) return false;" class="form-control" id="discount_on_medicines" name="discount_on_medicines"
        ...
        <div class="col-md-6 mt-3 show-hide-field">
            <label for="discount_on_consumables">Discount on consumables % <span
                    class="text-danger">*</span></label>
            <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>1) return false;" class="form-control" id="discount_on_consumables" name="discount_on_consumables"
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-select" id="referral_commission_offered" name="referral_commission_offered">
                <option value="">Select</option>
                <option disabled value="Yes" {{ old('referral_commission_offered', $hospital_tie_ups->referral_commission_offered??'') == 'Yes' ? 'selected' : '' }}>Yes
                </option>
                <option disabled value="No"
        ...
        <div class="col-md-6 mt-3 show-hide-referral">
            <label for="referral">Referral % <span
                    class="text-danger">*</span></label>
            <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>1) return false;" class="form-control" id="referral" name="referral"
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-select" id="claimstag_usage_services" name="claimstag_usage_services">
                <option value="">Select</option>
                <option disabled value="Monthly" {{ old('claimstag_usage_services', $hospital_tie_ups->claimstag_usage_services??'') == 'Monthly' ? 'selected' : '' }}>Monthly
                </option>
                <option disabled value="Half Yearly"
                    {{ old('claimstag_usage_services', $hospital_tie_ups->claimstag_usage_services??'') == 'Half Yearly' ? 'selected' : '' }}>Half Yearly
                </option>
                <option disabled value="Quarterly" {{ old('claimstag_usage_services', $hospital_tie_ups->claimstag_usage_services??'') == 'Quarterly' ? 'selected' : '' }}>Quarterly
                </option>
                <option disabled value="Yearly" {{ old('claimstag_usage_services', $hospital_tie_ups->claimstag_usage_services??'') == 'Yearly' ? 'selected' : '' }}>Yearly
                </option>
                <option disabled value="Pre Use" {{ old('claimstag_usage_services', $hospital_tie_ups->claimstag_usage_services??'') == 'Pre Use' ? 'selected' : '' }}>Pre Use
                </option>
                <option disabled value="No" {{ old('claimstag_usage_services', $hospital_tie_ups->claimstag_usage_services??'') == 'No' ? 'selected' : '' }}>No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-3">
            ...
            <div class="input-group">
                ...
                <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>5) return false;" class="form-control" id="claimstag_installation_charges" name="claimstag_installation_charges"
        ...
        <div class="col-md-6 mt-3">
            ...
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>5) return false;" class="form-control" id="claimstag_usage_charges" name="claimstag_usage_charges"
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-select" id="claims_reimbursement_insured_services" name="claims_reimbursement_insured_services">
                <option value="">Select</option>
                <option disabled value="Monthly" {{ old('claims_reimbursement_insured_services', $hospital_tie_ups->claims_reimbursement_insured_services??'') == 'Monthly' ? 'selected' : '' }}>Monthly
                </option>
                <option disabled value="Half Yearly"
                ...
                <option disabled value="Quarterly" {{ old('claims_reimbursement_insured_services', $hospital_tie_ups->claims_reimbursement_insured_services??'') == 'Quarterly' ? 'selected' : '' }}>Quarterly
                </option>
                <option disabled value="Yearly" {{ old('claims_reimbursement_insured_services', $hospital_tie_ups->claims_reimbursement_insured_services??'') == 'Yearly' ? 'selected' : '' }}>Yearly
                </option>
                <option disabled value="Pre Use" {{ old('claims_reimbursement_insured_services', $hospital_tie_ups->claims_reimbursement_insured_services??'') == 'Pre Use' ? 'selected' : '' }}>Pre Use
                </option>
                <option disabled value="No" {{ old('claims_reimbursement_insured_services', $hospital_tie_ups->claims_reimbursement_insured_services??'') == 'No' ? 'selected' : '' }}>No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-3">
            ...
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>5) return false;" class="form-control" id="claims_reimbursement_insured_service_charges" name="claims_reimbursement_insured_service_charges"
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-select" id="cashless_claims_management_services" name="cashless_claims_management_services">
                <option value="">Select</option>
                <option disabled value="Monthly" {{ old('cashless_claims_management_services', $hospital_tie_ups->cashless_claims_management_services??'') == 'Monthly' ? 'selected' : '' }}>Monthly
                </option>
                <option disabled value="Half Yearly"
                ...
                <option disabled value="Quarterly" {{ old('cashless_claims_management_services', $hospital_tie_ups->cashless_claims_management_services??'') == 'Quarterly' ? 'selected' : '' }}>Quarterly
                </option>
                <option disabled value="Yearly" {{ old('cashless_claims_management_services', $hospital_tie_ups->cashless_claims_management_services??'') == 'Yearly' ? 'selected' : '' }}>Yearly
                </option>
                <option disabled value="Pre Use" {{ old('cashless_claims_management_services', $hospital_tie_ups->cashless_claims_management_services??'') == 'Pre Use' ? 'selected' : '' }}>Pre Use
                </option>
                <option disabled value="No" {{ old('cashless_claims_management_services', $hospital_tie_ups->cashless_claims_management_services??'') == 'No' ? 'selected' : '' }}>No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-3">
            ...
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>5) return false;" class="form-control" id="cashless_claims_management_services_charges" name="cashless_claims_management_services_charges"
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-select" id="lending_finance_company_agreement" name="lending_finance_company_agreement">
                <option value="">Select</option>
                <option disabled value="Yes" {{ old('lending_finance_company_agreement', $hospital_tie_ups->lending_finance_company_agreement ?? '') == 'Yes' ? 'selected' : '' }}>Yes
                </option>
                <option disabled value="No"
            ...
            @endisset
            <input type="file" disabled name="lending_finance_company_agreement_file" @if($hospital_tie_ups->lending_finance_company_agreement == 'No') disabled @endif id="lending_finance_company_agreement_file" hidden />
        ...
        <div class="col-md-6 mt-3 show-hide-agrrement">
            ...
            <input type="date" readonly class="form-control" id="lending_finance_company_agreement_date" name="lending_finance_company_agreement_date"
        ...
        <div class="col-md-6 mt-3 show-hide-agrrement">
            ...
            <select class="form-select" id="medical_lending_for_patients" name="medical_lending_for_patients">
                <option value="">Select</option>
                <option disabled value="Yes" {{ old('medical_lending_for_patients', $hospital_tie_ups->medical_lending_for_patients??'') == 'Yes' ? 'selected' : '' }}>Yes
                </option>
                <option disabled value="No"
        ...
        <div class="col-md-6 mt-3 show-hide-agrrement">
            ...
            <select class="form-select" id="medical_lending_service_type" name="medical_lending_service_type">
                <option value="">Select</option>
                <option disabled value="Bridge" {{ old('medical_lending_service_type', $hospital_tie_ups->medical_lending_service_type ??'') == 'Bridge' ? 'selected' : '' }}>Bridge
                </option>
                <option disabled value="Term"
        ...
        <div class="col-md-6 mt-3 show-hide-agrrement">
            <label for="subvention">Subvention % <span
                    class="text-danger">*</span></label>
            <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>1) return false;" class="form-control" id="subvention" name="subvention"
        ...
        <div class="col-md-6 mt-3 show-hide-agrrement">
            ...
            <select class="form-select" id="medical_lending_for_bill_invoice_discounting" name="medical_lending_for_bill_invoice_discounting">
                <option value="">Select</option>
                <option disabled value="Yes" {{ old('medical_lending_for_bill_invoice_discounting', $hospital_tie_ups->medical_lending_for_bill_invoice_discounting??'') == 'Yes' ? 'selected' : '' }}>Yes
                </option>
                <option disabled value="No"
        ...
        <div class="col-md-12 mt-3">
            ...
            <select class="form-select" id="hospital_management_system_installation" name="hospital_management_system_installation">
                <option value="">Select</option>
                <option disabled value="Yes" {{ old('hospital_management_system_installation', $hospital_tie_ups->hospital_management_system_installation ?? '') == 'Yes' ? 'selected' : '' }}>Yes
                </option>
                <option disabled value="No"
        ...
        <div class="col-md-6 mt-3 show-hide-hms">
            ...
            <select class="form-select" id="hms_services" name="hms_services">
                <option value="">Select</option>
                <option disabled value="Monthly" {{ old('hms_services', $hospital_tie_ups->hms_services??'') == 'Monthly' ? 'selected' : '' }}>Monthly
                </option>
                <option disabled value="Half Yearly"
                    {{ old('hms_services', $hospital_tie_ups->hms_services??'') == 'Half Yearly' ? 'selected' : '' }}>Half Yearly
                </option>
                <option disabled value="Quarterly" {{ old('hms_services', $hospital_tie_ups->hms_services??'') == 'Quarterly' ? 'selected' : '' }}>Quarterly
                </option>
                <option disabled value="Yearly" {{ old('hms_services', $hospital_tie_ups->hms_services??'') == 'Yearly' ? 'selected' : '' }}>Yearly
                </option>
                <option disabled value="Pre Use" {{ old('hms_services', $hospital_tie_ups->hms_services??'') == 'Pre Use' ? 'selected' : '' }}>Pre Use
                </option>
                <option disabled value="No" {{ old('hms_services', $hospital_tie_ups->hms_services??'') == 'No' ? 'selected' : '' }}>No
                </option>
            </select>
            @error('hms_services')
                <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        ...
        <div class="col-md-6 mt-3 show-hide-hms">
            ...
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" readonly pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length>5) return false;" class="form-control" id="hms_charges" name="hms_charges"
        ...
        <div class="col-md-12 mt-3">
            ...
            <textarea readonly class="form-control" id="comments" name="comments" maxlength="250" placeholder="Comments" rows="4">{{ old('comments', $hospital_tie_ups->comments??'') }}</textarea>
            @error('comments')
                <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
