            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('hospital.admins.index') }}">
                                    ...
                                    <tbody>
                                        @foreach ($admins as $admin)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('hospital.admins.edit', $admin->id) }}"
                                                        ...
                                                        <form id='delete-form{{ $admin->id }}'
                                                            action='{{ route('hospital.admins.destroy', $admin->id) }}'
                                                            method='POST'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="changePasswordForm" action="{{ route('hospital.admins.change-password') }}">
                        @csrf
