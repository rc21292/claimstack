                        ...
                        <div class="row no-gutters">
                            <div class="col-md-12">
                                <dl class="row mb-0">
                                    ...
                                    <dd class="col-sm-6">
                                        <p class="card-text">: {{ @$hospital_tie_up->hospital->linkedEmployee->firstname}} {{ @$hospital_tie_up->hospital->linkedEmployee->lastname}} ({{ @$hospital_tie_up->hospital->linkedEmployee->employee_code}}) </p>
                                    </dd>
