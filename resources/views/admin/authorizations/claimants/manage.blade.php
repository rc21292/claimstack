            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('admin.claimant-authorizations.index') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-primary" href="{{ route('admin.claimant-authorizations.show', $claimant->id) }}">
                                                    ...
                                                    <form id='delete-form{{ $claimant->id }}'
                                                        action="{{ route('admin.claimant-authorizations.update', $claimant->id) }}"
                                                        method='POST'>
