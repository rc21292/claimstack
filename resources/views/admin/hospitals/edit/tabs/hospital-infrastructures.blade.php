<form action="{{ route('admin.hospitals.infrastructures', $hospital->id) }}" method="post" id="hospital-infrastructures-form"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-1 mt-32" style="margin-top: 45px !important;">
            <input type="file" name="nabl_approved_lab_file" id="supload" hidden />
        ...
        <div class="col-md-1 mt-32" style="margin-top: 45px !important;">
            <input type="file" name="nabh_status_file" id="supload" hidden />
            <label for="supload" class="btn btn-primary upload-label"><i
                class="mdi mdi-upload"></i></label>
        ...
        <div class="col-md-1 mt-32" style="margin-top: 45px !important;">
            <input type="file" name="nqac_nhsrc_status_file" id="supload" hidden />
            <label for="supload" class="btn btn-primary upload-label"><i
                class="mdi mdi-upload"></i></label>
        ...
        <div class="col-md-1 mt-32" style="margin-top: 45px !important;">
            <input type="file" name="jci_status_file" id="supload" hidden />
            <label for="supload" class="btn btn-primary upload-label"><i
                class="mdi mdi-upload"></i></label>
        ...
        <div class="col-md-1 mt-32" style="margin-top: 45px !important;">
            <input type="file" name="hippa_status_file" id="supload" hidden />
            <label for="supload" class="btn btn-primary upload-label"><i
                class="mdi mdi-upload"></i></label>
