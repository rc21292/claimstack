<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.hospital-documents.update', $hospital->id) }}"
                ...
                <div class="col-md-6 mt-3">
                    <div class="input-group">
                        ...
                        @isset($hospital_document->blood_bank)
                            <a href="{{ asset('storage/uploads/hospital/documents/' . $hospital_document->hospital_id . '/' . $hospital_document->blood_bank) }}"
                                download="" class="btn btn-warning download-label"><i
                                    class="mdi mdi-download"></i></a>
                        @endisset
