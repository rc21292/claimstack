                        ...
                        <form action="{{ route('admin.hospitals.import') }}" method="POST" id="submit-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        <a href="{{ route('admin.hospitals.export') }}" download="" class="btn btn-danger download-label"><i class="mdi mdi-download"></i> <br><span style="font-size: 18px;">Export Hospitals</span> </a>
