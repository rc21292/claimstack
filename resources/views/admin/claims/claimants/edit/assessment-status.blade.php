        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills  bg-nav-pills  nav-justified mb-3">
                    <li class="nav-item">
                        <a href="{{ route('admin.claimants.edit', $claimant->id) }}" aria-expanded="false"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.borrowers.show', $claimant->id) }}" aria-expanded="false"
                            class="nav-link rounded-0">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.claim-processing.show', $claimant->id) }}" aria-expanded="false"
                            class="nav-link rounded-0">
                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="assessment_status_tab">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.assessment-status.update', $claimant->id) }}"
