        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills  bg-nav-pills  nav-justified mb-3">
                    <li class="nav-item">
                        <a href="{{ route('admin.claimants.edit', $claimant->id)}}" aria-expanded="true" class="nav-link rounded-0 active">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="claimant_tab">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.claimants.update', $claimant->id) }}" method="post"
