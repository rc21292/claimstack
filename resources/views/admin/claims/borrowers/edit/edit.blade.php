...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.claims.index') }}">Claimants</a>
                            </li>
    ...
    <form action="{{ route('admin.borrowers.update',$id) }}" method="POST" id="borrower-details-form"
    ...
    $(document).ready(function () {
        $('#is_patient_and_borrower_same').on('change', function () {
            ...
            if(idCountry == 'Yes'){
                ...
                $.ajax({
                    url: "{{route('admin.claimants.fetch-patient', $claimant->patient_id)}}",
                    type: "GET",
                    data: {
                        _token: '{{csrf_token()}}'
                    },
        ...
        $('#is_claimant_and_borrower_same').on('change', function () {
            ...
            if(idState == 'Yes'){
                $.ajax({
                    url: "{{route('admin.claimants.fetch-claimant', $id)}}",
                    type: "GET",
                    data: {
                        _token: '{{csrf_token()}}'
                    },
