                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.claimants.index') }}">Borrowers</a>
                            </li>
            ...
            <div class="col-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="borrower_creation_tab">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.borrowers.borrowers-update', $claim->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" readonly class="form-control" id="claimant_id"
                                                ...
                                                value="{{ old('claimant_id', (isset($claimant) ? $claimant->uid : '')) }}">
                                            @error('claimant_id')
                                                <span id="claim-id-error"
                                                    class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="hospital_name"
                                                ...
                                                value="{{ old('hospital_name', @$claim->patient->hospital->name) }}" readonly>
                                            @error('hospital_name')
                                                <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <input type="text" class="form-control" id="hospital_city"
                                                ...
                                                value="{{ old('hospital_city', @$claim->patient->hospital->city) }}" readonly>
                                            @error('hospital_city')
                                                <span id="name-error"
                                                    class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <input type="text" class="form-control" id="hospital_state"
                                                ...
                                                value="{{ old('hospital_state', @$claim->patient->hospital->state) }}" readonly>
                                        ...
                                        <div class="col-md-3 mt-1 mb-3">
                                            <select class="form-control" id="patient_title" name="patient_title">
                                                ...
                                                <option @if (old('patient_title', @$claim->patient->title) == 'Mr.') selected @else disabled @endif
                                                    value="Mr.">Mr.</option>
                                                <option @if (old('patient_title', @$claim->patient->title) == 'Ms.') selected @else disabled @endif
                                                    value="Ms.">Ms.</option>
                                            </select>
                                            @error('patient_title')
                                                <span id="name-error"
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="policy_no" name="policy_no"
                                                ...
                                                value="{{ old('policy_no', $claim->policy_no) }}" readonly>
                                            @error('policy_no')
                                            ...
                                            <select class="form-control select2" id="insurance_company"
                                                ...
                                                @foreach ($insurers as $insurer)
                                                    <option value="{{ $insurer->id }}"
                                                        {{ old('insurance_company', @$claim->policy->insurer_id) == $insurer->id ? 'selected' : 'disabled' }}>
                                                        {{ $insurer->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-control select2" id="policy_name" name="policy_name"
                                                ...
                                                @foreach ($insurers as $insurer)
                                                    <option value="{{ $insurer->id }}"
                                                        {{ old('policy_name', @$claim->policy->policy_id) == $insurer->id ? 'selected' : 'disabled' }}>
                                                        {{ $insurer->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" maxlength="16" class="form-control"
                                                ...
                                                name="certificate_no"
                                                value="{{ old('certificate_no', @$claim->policy->certificate_no) }}"
                                                readonly>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="tpa_name" name="tpa_name"
                                                ...
                                                value="{{ old('tpa_name', @$claim->policy->tpa_name) }}"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="policy_type" name="policy_type"
                                                ...
                                                <option value="Group"
                                                    {{ old('policy_type', @$claim->policy->policy_type) == 'Group' ? 'selected' : 'disabled' }}>
                                                    Group
                                                </option>
                                                <option value="Retail"
                                                    {{ old('policy_type', @$claim->policy->policy_type) == 'Retail' ? 'selected' : 'disabled' }}>
                                                    Retail
                                                </option>
                                            </select>
                                            @error('policy_type')
        ...
        function claimantBorrowerSameOptions() {
            ...
            switch (is_claimant_and_borrower_same) {
                ...
                case 'No':
                    ...
                    $('#borrower_id_proof').val("{{ old('borrower_id_proof', @$borrower->borrower_id_proof) }}");
                    $('#borrower_personal_email_id').val("{{ old('borrower_personal_email_id', @$borrower->borrower_personal_email_id) }}");
                    $('#borrower_official_email_id').val("{{ old('borrower_official_email_id', @$borrower->borrower_official_email_id) }}");
                    $('#borrower_mobile_no').val("{{ old('borrower_mobile_no', @$borrower->borrower_mobile_no) }}");
