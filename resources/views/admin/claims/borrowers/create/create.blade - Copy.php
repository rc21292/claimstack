        ...
        <div class="row">
            <div class="col-12">
                <div class="card no-shadow">
                            <form action="{{ route('admin.borrowers.store') }}" method="post" id="borrower-create-form"
    ...
    $(document).ready(function () {
        $('#is_patient_and_borrower_same').on('change', function () {
            ...
            if(idCountry == 'Yes'){
                ...
                $.ajax({
                    url: "{{url('admin/claimants/patient/')}}/"+patientId,
                    type: "GET",
                    data: {
                        _token: '{{csrf_token()}}'
                    },
        ...
        $('#is_claimant_and_borrower_same').on('change', function () {
            ...
            if(idState == 'Yes'){
             ...
             var claimantId = $("#claimantId").val();
                ...
                $.ajax({
                    url: "{{url('admin/claimants/claimant/')}}/"+claimantId,
                    type: "GET",
                    data: {
                        _token: '{{csrf_token()}}'
                    },
