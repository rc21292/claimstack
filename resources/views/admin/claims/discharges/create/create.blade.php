                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.claimants.index') }}">Discharge Status</a>
                            </li>
            ...
            <div class="col-12">
                <div class="tab-content">
                    <div class="tab-pane show active" id="lending_status_tab">
                        ...
                        <form action="{{ route('admin.discharge-status.update-discharge-status', $claim->id) }}" method="POST"
