...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="page-title-right">
                        <div class="input-group">
                            <div class="input-group-append">
                                <a class="btn btn-primary" href="{{ route('admin.claim-reports-export', ['date_from_to' => request()->date_from_to, 'state' => request()->state, 'filter_hospital' => request()->filter_hospital ]) }}">Export Data</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <form action="{{ route('admin.claim-reports.index') }}">
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-warning" href="{{ route('admin.claim-reports.index') }}" >Reset</a>
                        </div>
                ...
                <div class="card no-shadow">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            ...
                            @else
                                <p class="text-center">No Claim Found.</p>
                            @endif
                        </div>
