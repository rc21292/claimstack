        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#"
                ...
                <span class="account-user-avatar">
                    <img @isset(Auth::guard('admin')->user()->avatar) src="{{asset('storage/uploads/admin/'.Auth::guard('admin')->user()->avatar) }}" @else src={{ asset('assets/images/users/avatar-1.jpg') }} @endisset alt="user-image" class="rounded-circle">
                </span>
                <span>
                    <span class="account-user-name">{{ Auth::guard('admin')->user()->firstname }}
