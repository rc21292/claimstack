...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="page-title-right">
                            <div class="input-group">
                                <div class="input-group-append">
                                    <a class="btn btn-primary" href="{{ route('admin.document-inward-outward-tracking.create') }}">Add Trcking</a>
                                </div>
                            </div>
                    </div>
            ...
            <div class="container">
                <form action="{{ route('admin.document-inward-outward-tracking.index') }}">
                                    ...
                                    <tbody>
                                        @foreach ($document_inward_outward_trackings as $document_inward_outward_tracking)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('admin.document-inward-outward-tracking.edit', $document_inward_outward_tracking->id) }}"
                                                            class="btn btn-secondary"><i class="mdi mdi-pencil"></i></a>
                                                    <a href="{{ route('admin.document-inward-outward-tracking.show', $document_inward_outward_tracking->id) }}"
