                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('claimant.password.email') }}" method="POST">
                                    @csrf
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Back to <a href="{{ route('claimant.login') }}" class="text-muted ml-1"><b>Log In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                    </div> <!-- end col -->
                </div>
