        ...
        <div id="moduleCreationTab" class="collapse"
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <input class="form-check-input me-1 float-end mcer" name="permission[]" type="checkbox" {{ in_array($permission->name, $admin->permissions) ? 'checked' : '' }} {{ (collect(old('permission'))->contains($permission->name)) ? 'checked':'' }}  value="{{ $permission->name }}">
                        {{ $permission->name }}
                    </li>
        ...
        <div id="loginCreationTab" class="collapse"
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    @endif
                    <li class="list-group-item">
                        <input class="form-check-input me-1 float-end lcr" name="permission[]" type="checkbox" {{ in_array($permission->name, $admin->permissions) ? 'checked' : '' }} {{ (collect(old('permission'))->contains($permission->name)) ? 'checked':'' }} value="{{ $permission->name }}">
                        {{ $permission->name }}
                    </li>
        ...
        <div id="updateEditingTab" class="collapse"
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    @endif
                    <li class="list-group-item">
                        <input class="form-check-input me-1 float-end uer" name="permission[]" type="checkbox" {{ in_array($permission->name, $admin->permissions) ? 'checked' : '' }} {{ (collect(old('permission'))->contains($permission->name)) ? 'checked':'' }} value="{{ $permission->name }}">
                        {{ $permission->name }}
                    </li>
        ...
        <div id="claimProcessingTab" class="collapse"
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    @endif
                    <li class="list-group-item">
                        <input class="form-check-input me-1 float-end cr" name="permission[]" type="checkbox" {{ in_array($permission->name, $admin->permissions) ? 'checked' : '' }} {{ (collect(old('permission'))->contains($permission->name)) ? 'checked':'' }} value="{{ $permission->name }}">
                        {{ $permission->name }}
                    </li>
        ...
        <div id="authorizationRightsTab" class="collapse"
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    @endif
                    <li class="list-group-item">
                        <input class="form-check-input me-1 float-end ar" name="permission[]" type="checkbox" {{ in_array($permission->name, $admin->permissions) ? 'checked' : '' }} {{ (collect(old('permission'))->contains($permission->name)) ? 'checked':'' }} value="{{ $permission->name }}">
                        {{ $permission->name }}
                    </li>
        ...
        <div id="claimVerificationTab" class="collapse"
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    @endif
                    <li class="list-group-item">
                        <input class="form-check-input me-1 float-end cvr" name="permission[]" type="checkbox" {{ in_array($permission->name, $admin->permissions) ? 'checked' : '' }} {{ (collect(old('permission'))->contains($permission->name)) ? 'checked':'' }} value="{{ $permission->name }}">
                        {{ $permission->name }}
                    </li>
        ...
        <div id="otherRightsTab" class="collapse"
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    @endif
                    <li class="list-group-item">
                        <input class="form-check-input me-1 float-end or" name="permission[]" type="checkbox" {{ in_array($permission->name, $admin->permissions) ? 'checked' : '' }} {{ (collect(old('permission'))->contains($permission->name)) ? 'checked':'' }} value="{{ $permission->name }}">
                        {{ $permission->name }}
                    </li>
