                        ...
                        <form action="{{ route('super-admin.admins.store') }}" method="post" id="adminForm"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 mt-1">
                                    <input type="text" onkeydown="return /[a-z]/i.test(event.key)"  onkeydown="return /[a-z]/i.test(event.key)" class="form-control" id="firstname" name="firstname"
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <input type="text" onkeydown="return /[a-z]/i.test(event.key)"  class="form-control" id="designation" name="designation"
                                        maxlength="30" placeholder="Enter designation" value="{{ old('designation') }}">
                                    @error('designation')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mt-3 div_linked_employee">
                                    ...
                                    <select class="form-control select2" id="linked_employee" data-toggle="select2"
                                        name="linked_employee" onchange="setLinkedWithEmployeeId()">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="kra" name="kra"
                                        maxlength="40" placeholder="Enter kra" value="{{ old('kra') }}">
                                    @error('kra')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-12 mt-3">
                                    ...
                                    @include('super-admin.admins.create.permission')
                                </div>
