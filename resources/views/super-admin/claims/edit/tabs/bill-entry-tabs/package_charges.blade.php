<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('package_charges_date', $bill_entry->package_charges_date) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('package_charges_from', $bill_entry->package_charges_from) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="package_charges_to" name="package_charges_to" placeholder="To" value="{{ old('package_charges_to', $bill_entry->package_charges_to) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="package_charges_total_days" name="package_charges_total_days" placeholder="Total Days" value="{{ old('package_charges_total_days', $bill_entry->package_charges_total_days) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="package_charges_amount" name="package_charges_amount" placeholder="Amount" value="{{ old('package_charges_amount', $bill_entry->package_charges_amount) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="package_charges_total_amount" name="package_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('package_charges_total_amount', $bill_entry->package_charges_total_amount) }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('gipsa_ppn_packages_date', $bill_entry->gipsa_ppn_packages_date) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('gipsa_ppn_packages_from', $bill_entry->gipsa_ppn_packages_from) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="gipsa_ppn_packages_to" name="gipsa_ppn_packages_to" placeholder="To" value="{{ old('gipsa_ppn_packages_to', $bill_entry->gipsa_ppn_packages_to) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="gipsa_ppn_packages_total_days" name="gipsa_ppn_packages_total_days" placeholder="Total Days" value="{{ old('gipsa_ppn_packages_total_days', $bill_entry->gipsa_ppn_packages_total_days) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="gipsa_ppn_packages_amount" name="gipsa_ppn_packages_amount" placeholder="Amount" value="{{ old('gipsa_ppn_packages_amount', $bill_entry->gipsa_ppn_packages_amount) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="gipsa_ppn_packages_total_amount" name="gipsa_ppn_packages_total_amount" placeholder="Total Days * Amount" value="{{ old('gipsa_ppn_packages_total_amount', $bill_entry->gipsa_ppn_packages_total_amount) }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('bhc_packages_date', $bill_entry->bhc_packages_date) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('bhc_packages_from', $bill_entry->bhc_packages_from) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="bhc_packages_to" name="bhc_packages_to" placeholder="To" value="{{ old('bhc_packages_to', $bill_entry->bhc_packages_to) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="bhc_packages_total_days" name="bhc_packages_total_days" placeholder="Total Days" value="{{ old('bhc_packages_total_days', $bill_entry->bhc_packages_total_days) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="bhc_packages_amount" name="bhc_packages_amount" placeholder="Amount" value="{{ old('bhc_packages_amount', $bill_entry->bhc_packages_amount) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="bhc_packages_total_amount" name="bhc_packages_total_amount" placeholder="Total Days * Amount" value="{{ old('bhc_packages_total_amount', $bill_entry->bhc_packages_total_amount) }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('other_date', $bill_entry->other_date) }}">
        @error('other_date')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('other_from', $bill_entry->other_from) }}">
        @error('other_from')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="other_to" name="other_to" placeholder="To" value="{{ old('other_to', $bill_entry->other_to) }}">
        @error('other_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="other_total_days" name="other_total_days" placeholder="Total Days" value="{{ old('other_total_days', $bill_entry->other_total_days) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="other_amount" name="other_amount" placeholder="Amount" value="{{ old('other_amount', $bill_entry->other_amount) }}">
        @error('other_amount')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="other_total_amount" name="other_total_amount" placeholder="Total Days * Amount" value="{{ old('other_total_amount', $bill_entry->other_total_amount) }}">
