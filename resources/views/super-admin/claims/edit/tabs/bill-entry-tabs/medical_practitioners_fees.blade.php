<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('medical_practitioners_fees_date, $bill_entry->medical_practitioners_fees_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('medical_practitioners_fees_from, $bill_entry->medical_practitioners_fees_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="medical_practitioners_fees_to" name="medical_practitioners_fees_to" placeholder="To" value="{{ old('medical_practitioners_fees_to, $bill_entry->medical_practitioners_fees_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="medical_practitioners_fees_total_days" name="medical_practitioners_fees_total_days" placeholder="Total Days" value="{{ old('medical_practitioners_fees_total_days, $bill_entry->medical_practitioners_fees_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="medical_practitioners_fees_amount" name="medical_practitioners_fees_amount" placeholder="Amount" value="{{ old('medical_practitioners_fees_amount, $bill_entry->medical_practitioners_fees_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="medical_practitioners_fees_total_amount" name="medical_practitioners_fees_total_amount" placeholder="Total Days * Amount" value="{{ old('medical_practitioners_fees_total_amount, $bill_entry->medical_practitioners_fees_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('specialists_visit_date, $bill_entry->specialists_visit_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('specialists_visit_from, $bill_entry->specialists_visit_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="specialists_visit_to" name="specialists_visit_to" placeholder="To" value="{{ old('specialists_visit_to, $bill_entry->specialists_visit_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="specialists_visit_total_days" name="specialists_visit_total_days" placeholder="Total Days" value="{{ old('specialists_visit_total_days, $bill_entry->specialists_visit_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="specialists_visit_amount" name="specialists_visit_amount" placeholder="Amount" value="{{ old('specialists_visit_amount, $bill_entry->specialists_visit_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="specialists_visit_total_amount" name="specialists_visit_total_amount" placeholder="Total Days * Amount" value="{{ old('specialists_visit_total_amount, $bill_entry->specialists_visit_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('consultants_visit_date, $bill_entry->consultants_visit_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('consultants_visit_from, $bill_entry->consultants_visit_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="consultants_visit_to" name="consultants_visit_to" placeholder="To" value="{{ old('consultants_visit_to, $bill_entry->consultants_visit_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="consultants_visit_total_days" name="consultants_visit_total_days" placeholder="Total Days" value="{{ old('consultants_visit_total_days, $bill_entry->consultants_visit_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="consultants_visit_amount" name="consultants_visit_amount" placeholder="Amount" value="{{ old('consultants_visit_amount, $bill_entry->consultants_visit_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="consultants_visit_total_amount" name="consultants_visit_total_amount" placeholder="Total Days * Amount" value="{{ old('consultants_visit_total_amount, $bill_entry->consultants_visit_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('surgeon_fees_visit_date, $bill_entry->surgeon_fees_visit_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('surgeon_fees_visit_from, $bill_entry->surgeon_fees_visit_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="surgeon_fees_visit_to" name="surgeon_fees_visit_to" placeholder="To" value="{{ old('surgeon_fees_visit_to, $bill_entry->surgeon_fees_visit_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="surgeon_fees_visit_total_days" name="surgeon_fees_visit_total_days" placeholder="Total Days" value="{{ old('surgeon_fees_visit_total_days, $bill_entry->surgeon_fees_visit_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="surgeon_fees_visit_amount" name="surgeon_fees_visit_amount" placeholder="Amount" value="{{ old('surgeon_fees_visit_amount, $bill_entry->surgeon_fees_visit_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="surgeon_fees_visit_total_amount" name="surgeon_fees_visit_total_amount" placeholder="Total Days * Amount" value="{{ old('surgeon_fees_visit_total_amount, $bill_entry->surgeon_fees_visit_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('anaesthetist_date, $bill_entry->anaesthetist_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('anaesthetist_from, $bill_entry->anaesthetist_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="anaesthetist_to" name="anaesthetist_to" placeholder="To" value="{{ old('anaesthetist_to, $bill_entry->anaesthetist_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="anaesthetist_total_days" name="anaesthetist_total_days" placeholder="Total Days" value="{{ old('anaesthetist_total_days, $bill_entry->anaesthetist_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="anaesthetist_amount" name="anaesthetist_amount" placeholder="Amount" value="{{ old('anaesthetist_amount, $bill_entry->anaesthetist_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="anaesthetist_total_amount" name="anaesthetist_total_amount" placeholder="Total Days * Amount" value="{{ old('anaesthetist_total_amount, $bill_entry->anaesthetist_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('ot_assistant_date, $bill_entry->ot_assistant_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('ot_assistant_from, $bill_entry->ot_assistant_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="ot_assistant_to" name="ot_assistant_to" placeholder="To" value="{{ old('ot_assistant_to, $bill_entry->ot_assistant_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="ot_assistant_total_days" name="ot_assistant_total_days" placeholder="Total Days" value="{{ old('ot_assistant_total_days, $bill_entry->ot_assistant_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="ot_assistant_amount" name="ot_assistant_amount" placeholder="Amount" value="{{ old('ot_assistant_amount, $bill_entry->ot_assistant_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="ot_assistant_total_amount" name="ot_assistant_total_amount" placeholder="Total Days * Amount" value="{{ old('ot_assistant_total_amount, $bill_entry->ot_assistant_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('physiotherapy_date, $bill_entry->physiotherapy_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('physiotherapy_from, $bill_entry->physiotherapy_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="physiotherapy_to" name="physiotherapy_to" placeholder="To" value="{{ old('physiotherapy_to, $bill_entry->physiotherapy_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="physiotherapy_total_days" name="physiotherapy_total_days" placeholder="Total Days" value="{{ old('physiotherapy_total_days, $bill_entry->physiotherapy_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="physiotherapy_amount" name="physiotherapy_amount" placeholder="Amount" value="{{ old('physiotherapy_amount, $bill_entry->physiotherapy_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="physiotherapy_total_amount" name="physiotherapy_total_amount" placeholder="Total Days * Amount" value="{{ old('physiotherapy_total_amount, $bill_entry->physiotherapy_total_amount') }}">
