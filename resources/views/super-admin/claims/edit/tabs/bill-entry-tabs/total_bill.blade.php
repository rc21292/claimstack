<div class="form-group row">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="hospital_amount" name="hospital_amount" placeholder="Total Days * Amount" value="{{ old('hospital_amount', $bill_entry->hospital_amount) }}">
 ...
 <h5 class="mt-1">BHC Amount</h5>
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="bhc_amount" name="bhc_amount" placeholder="Amount" value="{{ old('bhc_amount', $bill_entry->bhc_amount) }}">
        @error('bhc_amount')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-4 mt-1"> 
        ...
        <input type="number" class="form-control" id="bhc_total_amount" name="bhc_total_amount" placeholder="Total Days * Amount" value="{{ old('bhc_total_amount', $bill_entry->bhc_total_amount) }}">
