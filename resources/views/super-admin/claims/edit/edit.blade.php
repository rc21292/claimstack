                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="claim">
                                @include('super-admin.claims.edit.tabs.patient')
                            </div>

                            <div class="tab-pane" id="claim">
                                @include('super-admin.claims.edit.tabs.claim')
                            </div>

                            <div class="tab-pane" id="claim">
                                @include('super-admin.claims.edit.tabs.policy')
                            </div>

                            <div class="tab-pane" id="claim">
                                @include('super-admin.claims.edit.tabs.claiment')
                            </div>                            
