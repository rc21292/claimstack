                    ...
                    <div class="card-body mb-4">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <input type="number" class="form-control" id="final_assessment_amount" name="final_assessment_amount"
                                pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==8) return false;"
                                placeholder="Enter Estimated Amount"
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="input-group">
                                    ...
                                    name="loan_id_or_no" placeholder="Enter Loan ID / No."  value="{{ old('loan_id_or_no',$borrower->loan_id_or_no) }}">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="input-group">
                                    ...
                                    name="loan_approved_amount" maxlength="30" placeholder="Enter Loan Approved Amount"  value="{{ old('loan_approved_amount',$borrower->loan_approved_amount) }}">
                                    <a id="borrower_pan_no_file_download" style="display:none;" href="" download="" class="btn btn-warning download-label"><i class="mdi mdi-download"></i></a>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="insurance_claim_settled_amount" name="insurance_claim_settled_amount" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==8) return false;"
