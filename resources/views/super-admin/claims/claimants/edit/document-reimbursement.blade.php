        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('super-admin.document-reimbursement.show', $claimant->id) }}" aria-expanded="true"
                ...
                <div class="tab-content">
                    <div class="tab-pane" id="claimant_tab">
                        ...
                    </div>
                    ...
                    <div class="tab-pane show active" id="document_reimbursement_tab">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('super-admin.document-reimbursement.update', $claimant->id) }}"
