        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills  bg-nav-pills  nav-justified mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('super-admin.discharge-status.show', $claimant->id) }}" aria-expanded="true"
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="lending_status_tab">
                        ...
                        <form action="{{ route('super-admin.discharge-status.update', $claimant->id) }}" method="POST"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="admission_date">Date of Admission (DD-MM-YYYY) <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" class="form-control" id="admission_date"
                                                name="admission_date"
                                                value="{{ old('admission_date', $claimant->claim->admission_date) }}">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="admission_time">Time of Admission (HH:MM) <span
                                                    class="text-danger">*</span></label>
                                            <input type="time" class="form-control" id="admission_time"
                                                name="admission_time"
                                                value="{{ old('admission_time', $claimant->claim->admission_time) }}">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label for="mlc_report_and_police_fir_attached">MLC Report & Police FIR
                                                attached <span class="text-danger">*</span></label>
                                            <div class="mt-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="not_reported_to_police_reason">If not reported to Police, give
                                                reason </label>
                                            <input type="text" class="form-control" id="not_reported_to_police_reason" name="not_reported_to_police_reason" value="{{ old('not_reported_to_police_reason', isset($discharge_status) ? $discharge_status->not_reported_to_police_reason : '') }}" maxlength="100" placeholder="Claimant Comments">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            <label for="maternity_date_of_delivery">If Maternity - Date of Delivery<span
                                                    class="text-danger">*</span></label>
                                            <input type="date" class="form-control" id="maternity_date_of_delivery"
