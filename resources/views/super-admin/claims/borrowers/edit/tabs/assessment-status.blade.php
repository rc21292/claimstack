    ...
    <div class="card-body mb-4">
        <div class="form-group row">
            ...
            <div class="col-md-6 mt-3">
                ...
                placeholder="Enter Hospital on the Panel of Insurance Co." value="{{ old('hospital_on_the_panel_of_insurance_co') }}">
            ...
            <div class="col-md-6 mt-3">
                ...
                placeholder="Enter Hospital ID (Insurance Co.) " value="{{ old('hospital_id_insurance_co') }}">
            ...
            <div class="col-md-6 mt-3">
                ...
                <select class="form-select" id="pre_assessment_status" name="pre_assessment_status">
            ...
            <div class="col-md-6 mt-3">
                ...
                <input type="text" placeholder="Enter Policy Start Date" class="form-control query_pre_assessment" id="query_pre_assessment"
            ...
            <div class="col-md-6 mt-3">
                ...
                <div class="input-group">
                    <select class="form-select pre_assessment_suspected_fraud" id="pre_assessment_suspected_fraud" name="pre_assessment_suspected_fraud">
                        <option value="">Select</option>
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <textarea class="form-control" id="pre_assessment_status_comments" name="pre_assessment_status_comments" maxlength="250" placeholder="Pre-Assessment Status Comments"
                ...
                <div class="col-md-12 mt-3 bg-secondary text-white" style="line-height: 30px; margin-left: 2px; ;">  Final Assessment </div>


                <div class="col-md-6 mt-3">
                    <label for="final_assessment_status">Final Assessment Status <span class="text-danger">*</span></label>
                    <select class="form-select final_assessment_status" id="final_assessment_status" name="final_assessment_status">
                        <option value="">Select</option>
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <input type="text" placeholder="Enter Query - Final Assessment" readonly class="form-control query_final_assessment" id="query_final_assessment"
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <input type="number" placeholder="Enter Final Assessment Amount" class="form-control" id="final_assessment_amount"
                    name="final_assessment_amount" value="{{ old('final_assessment_amount') ?? 0 }}">
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <div class="input-group">
                        <select class="form-select final_assessment_suspected_fraud" id="final_assessment_suspected_fraud" name="final_assessment_suspected_fraud">
                            <option value="">Select</option>
                        ...
                        <label for="final_assessment_suspected_fraud_file" class="btn btn-primary upload-label"><i class="mdi mdi-upload"></i></label>
                    </div>
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <textarea class="form-control" id="final_assessment_status_comments" name="final_assessment_status_comments" maxlength="250" placeholder="Enter Final Assessment Status Comments"
...
@push('scripts')
<script>
    $(".final_assessment_suspected_fraud").change(function(event) {
        if($(this).val() == 'Yes'){
    ...
    $(document).on('change', '#final_assessment_status', function(event) {
        if($(this).val() == 'Query Raised by BHC Team'){
            $(".query_final_assessment").removeAttr('readonly');
        }else{
            $(".query_final_assessment").attr('readonly', true);
        }
    });


    $(".pre_assessment_suspected_fraud").change(function(event) {
        if($(this).val() == 'Yes'){
            $("#pre_assessment_status").val('Non Admissible as per the Policy TC').trigger('change');
        }
    });

    $(document).on('change', '#pre_assessment_status', function(event) {
        if($(this).val() == 'Query Raised by BHC Team'){
            $(".query_pre_assessment").removeAttr('readonly');
        }else{
            $(".query_pre_assessment").attr('readonly', true);
        }
    });
