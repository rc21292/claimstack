                            ...
                            <div class="card-body">
                                <form action="{{ route('super-admin.icclaim-status.update', $claimant->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_receiving_main_claim_documents">Date of Receiving (Main Claim) Documents <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_dispatching_main_claim_documents_to_ic_or_tpa">Date of Dispatching (Main Claim) Documents to IC/TPA <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_receiving_pre_claim_documents">Date of Receiving (Pre Claim) Documents <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_dispatching_pre_claim_documents_to_ic_or_tpa">Date of Dispatching (Pre Claim) Documents to IC/TPA<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_receiving_post_claim_documents">Date of Receiving (Post Claim) Documents <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_dispatching_post_claim_documents_to_ic_or_tpa">Date of Dispatching (Post Claim) Documents to IC/TPA <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_receiving_query1_documents">Date of Receiving Query - 1 Documents <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_dispatching_query1_documents_to_ic_or_tpa">Date of Dispatching Query - 1 Documents to IC/TPA <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_receiving_query2_documents">Date of Receiving Query - 2 Documents <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_dispatching_query2_documents_to_ic_or_tpa">Date of Dispatching Query - 2 Documents to IC/TPA<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_receiving_query3_documents">Date of Receiving Query - 3 Documents <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_dispatching_query3_documents_to_ic_or_tpa">Date of Dispatching Query - 3 Documents to IC/TPA <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_settlement">Date of Settlement <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="settled_amount">Settled Amount <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="date_disbursement">Date of Disbursement <span class="text-danger">*</span></label>
