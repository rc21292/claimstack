<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('room_rent_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('room_rent_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="room_rent_to" name="room_rent_to" placeholder="To" value="{{ old('room_rent_to') }}">
        @error('room_rent_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="room_rent_total_days" name="room_rent_total_days" placeholder="Total Days" value="{{ old('room_rent_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="room_rent_amount" name="room_rent_amount" placeholder="Amount" value="{{ old('room_rent_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="room_rent_total_amount" name="room_rent_total_amount" placeholder="Total Days * Amount" value="{{ old('room_rent_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('icu_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('icu_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="icu_charges_to" name="icu_charges_to" placeholder="To" value="{{ old('icu_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="icu_charges_total_days" name="icu_charges_total_days" placeholder="Total Days" value="{{ old('icu_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="icu_charges_amount" name="icu_charges_amount" placeholder="Amount" value="{{ old('icu_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="icu_charges_total_amount" name="icu_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('icu_charges_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('nursing_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('nursing_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="nursing_charges_to" name="nursing_charges_to" placeholder="To" value="{{ old('nursing_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="nursing_charges_total_days" name="nursing_charges_total_days" placeholder="Total Days" value="{{ old('nursing_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="nursing_charges_amount" name="nursing_charges_amount" placeholder="Amount" value="{{ old('nursing_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="nursing_charges_total_amount" name="nursing_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('nursing_charges_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('diet_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('diet_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="diet_charges_to" name="diet_charges_to" placeholder="To" value="{{ old('diet_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="diet_charges_total_days" name="diet_charges_total_days" placeholder="Total Days" value="{{ old('diet_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="diet_charges_amount" name="diet_charges_amount" placeholder="Amount" value="{{ old('diet_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="diet_charges_total_amount" name="diet_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('diet_charges_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('rmo_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('rmo_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="rmo_charges_to" name="rmo_charges_to" placeholder="To" value="{{ old('rmo_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="rmo_charges_total_days" name="rmo_charges_total_days" placeholder="Total Days" value="{{ old('rmo_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="rmo_charges_amount" name="rmo_charges_amount" placeholder="Amount" value="{{ old('rmo_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="rmo_charges_total_amount" name="rmo_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('rmo_charges_total_amount') }}">
