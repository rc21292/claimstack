<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('ambulance_charges_date') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('ambulance_charges_from') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="ambulance_charges_to" name="ambulance_charges_to" placeholder="To" value="{{ old('ambulance_charges_to') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="ambulance_charges_total_days" name="ambulance_charges_total_days" placeholder="Total Days" value="{{ old('ambulance_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="ambulance_charges_amount" name="ambulance_charges_amount" placeholder="Amount" value="{{ old('ambulance_charges_amount') }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="ambulance_charges_total_amount" name="ambulance_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('ambulance_charges_total_amount') }}">
