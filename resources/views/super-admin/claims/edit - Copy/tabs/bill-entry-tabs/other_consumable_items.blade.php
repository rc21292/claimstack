<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('other_consumable_items_date') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('other_consumable_items_from') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="other_consumable_items_to" name="other_consumable_items_to" placeholder="To" value="{{ old('other_consumable_items_to') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="other_consumable_items_total_days" name="other_consumable_items_total_days" placeholder="Total Days" value="{{ old('other_consumable_items_total_days') }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="other_consumable_items_amount" name="other_consumable_items_amount" placeholder="Amount" value="{{ old('other_consumable_items_amount') }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="other_consumable_items_total_amount" name="other_consumable_items_total_amount" placeholder="Total Days * Amount" value="{{ old('other_consumable_items_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('payable_consumables_date') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('payable_consumables_from') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="payable_consumables_to" name="payable_consumables_to" placeholder="To" value="{{ old('payable_consumables_to') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="payable_consumables_total_days" name="payable_consumables_total_days" placeholder="Total Days" value="{{ old('payable_consumables_total_days') }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="payable_consumables_amount" name="payable_consumables_amount" placeholder="Amount" value="{{ old('payable_consumables_amount') }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="payable_consumables_total_amount" name="payable_consumables_total_amount" placeholder="Total Days * Amount" value="{{ old('payable_consumables_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('non_payable_consumables_date') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('non_payable_consumables_from') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="non_payable_consumables_to" name="non_payable_consumables_to" placeholder="To" value="{{ old('non_payable_consumables_to') }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="non_payable_consumables_total_days" name="non_payable_consumables_total_days" placeholder="Total Days" value="{{ old('non_payable_consumables_total_days') }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="non_payable_consumables_amount" name="non_payable_consumables_amount" placeholder="Amount" value="{{ old('non_payable_consumables_amount') }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="non_payable_consumables_total_amount" name="non_payable_consumables_total_amount" placeholder="Total Days * Amount" value="{{ old('non_payable_consumables_total_amount') }}">
