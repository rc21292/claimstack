<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('administration_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('administration_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="administration_charges_to" name="administration_charges_to" placeholder="To" value="{{ old('administration_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="administration_charges_total_days" name="administration_charges_total_days" placeholder="Total Days" value="{{ old('administration_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="administration_charges_amount" name="administration_charges_amount" placeholder="Amount" value="{{ old('administration_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="administration_charges_total_amount" name="administration_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('administration_charges_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('iv_fluids_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('iv_fluids_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="iv_fluids_to" name="iv_fluids_to" placeholder="To" value="{{ old('iv_fluids_to') }}">
        @error('iv_fluids_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="iv_fluids_total_days" name="iv_fluids_total_days" placeholder="Total Days" value="{{ old('iv_fluids_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="iv_fluids_amount" name="iv_fluids_amount" placeholder="Amount" value="{{ old('iv_fluids_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="iv_fluids_total_amount" name="iv_fluids_total_amount" placeholder="Total Days * Amount" value="{{ old('iv_fluids_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('blood_transfusion_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('blood_transfusion_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="blood_transfusion_to" name="blood_transfusion_to" placeholder="To" value="{{ old('blood_transfusion_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="blood_transfusion_total_days" name="blood_transfusion_total_days" placeholder="Total Days" value="{{ old('blood_transfusion_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="blood_transfusion_amount" name="blood_transfusion_amount" placeholder="Amount" value="{{ old('blood_transfusion_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="blood_transfusion_total_amount" name="blood_transfusion_total_amount" placeholder="Total Days * Amount" value="{{ old('blood_transfusion_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('injection_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('injection_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="injection_to" name="injection_to" placeholder="To" value="{{ old('injection_to') }}">
        @error('injection_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="injection_total_days" name="injection_total_days" placeholder="Total Days" value="{{ old('injection_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="injection_amount" name="injection_amount" placeholder="Amount" value="{{ old('injection_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="injection_total_amount" name="injection_total_amount" placeholder="Total Days * Amount" value="{{ old('injection_total_amount') }}">
