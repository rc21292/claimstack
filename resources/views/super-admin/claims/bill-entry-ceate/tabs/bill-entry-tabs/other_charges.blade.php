<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('other_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('other_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="other_charges_to" name="other_charges_to" placeholder="To" value="{{ old('other_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="other_charges_total_days" name="other_charges_total_days" placeholder="Total Days" value="{{ old('other_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="other_charges_amount" name="other_charges_amount" placeholder="Amount" value="{{ old('other_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="other_charges_total_amount" name="other_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('other_charges_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('anaesthesia_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('anaesthesia_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="anaesthesia_to" name="anaesthesia_to" placeholder="To" value="{{ old('anaesthesia_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="anaesthesia_total_days" name="anaesthesia_total_days" placeholder="Total Days" value="{{ old('anaesthesia_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="anaesthesia_amount" name="anaesthesia_amount" placeholder="Amount" value="{{ old('anaesthesia_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="anaesthesia_total_amount" name="anaesthesia_total_amount" placeholder="Total Days * Amount" value="{{ old('anaesthesia_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('blood_date') }}">
        @error('blood_date')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('blood_from') }}">
        @error('blood_from')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="blood_to" name="blood_to" placeholder="To" value="{{ old('blood_to') }}">
        @error('blood_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="blood_total_days" name="blood_total_days" placeholder="Total Days" value="{{ old('blood_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="blood_amount" name="blood_amount" placeholder="Amount" value="{{ old('blood_amount') }}">
        @error('blood_amount')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="blood_total_amount" name="blood_total_amount" placeholder="Total Days * Amount" value="{{ old('blood_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('oxygen_date') }}">
        @error('oxygen_date')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('oxygen_from') }}">
        @error('oxygen_from')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="oxygen_to" name="oxygen_to" placeholder="To" value="{{ old('oxygen_to') }}">
        @error('oxygen_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="oxygen_total_days" name="oxygen_total_days" placeholder="Total Days" value="{{ old('oxygen_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="oxygen_amount" name="oxygen_amount" placeholder="Amount" value="{{ old('oxygen_amount') }}">
        @error('oxygen_amount')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="oxygen_total_amount" name="oxygen_total_amount" placeholder="Total Days * Amount" value="{{ old('oxygen_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('operation_theatre_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('operation_theatre_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="operation_theatre_charges_to" name="operation_theatre_charges_to" placeholder="To" value="{{ old('operation_theatre_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="operation_theatre_charges_total_days" name="operation_theatre_charges_total_days" placeholder="Total Days" value="{{ old('operation_theatre_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="operation_theatre_charges_amount" name="operation_theatre_charges_amount" placeholder="Amount" value="{{ old('operation_theatre_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="operation_theatre_charges_total_amount" name="operation_theatre_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('operation_theatre_charges_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('surgical_appliances_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('surgical_appliances_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="surgical_appliances_charges_to" name="surgical_appliances_charges_to" placeholder="To" value="{{ old('surgical_appliances_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="surgical_appliances_charges_total_days" name="surgical_appliances_charges_total_days" placeholder="Total Days" value="{{ old('surgical_appliances_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="surgical_appliances_charges_amount" name="surgical_appliances_charges_amount" placeholder="Amount" value="{{ old('surgical_appliances_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="surgical_appliances_charges_total_amount" name="surgical_appliances_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('surgical_appliances_charges_total_amount') }}">
