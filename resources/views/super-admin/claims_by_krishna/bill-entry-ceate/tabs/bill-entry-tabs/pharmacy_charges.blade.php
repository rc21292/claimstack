<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('pharmacy_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('pharmacy_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="pharmacy_charges_to" name="pharmacy_charges_to" placeholder="To" value="{{ old('pharmacy_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="pharmacy_charges_total_days" name="pharmacy_charges_total_days" placeholder="Total Days" value="{{ old('pharmacy_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="pharmacy_charges_amount" name="pharmacy_charges_amount" placeholder="Amount" value="{{ old('pharmacy_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="pharmacy_charges_total_amount" name="pharmacy_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('pharmacy_charges_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('medicines_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('medicines_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="medicines_to" name="medicines_to" placeholder="To" value="{{ old('medicines_to') }}">
        @error('medicines_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="medicines_total_days" name="medicines_total_days" placeholder="Total Days" value="{{ old('medicines_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="medicines_amount" name="medicines_amount" placeholder="Amount" value="{{ old('medicines_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="medicines_total_amount" name="medicines_total_amount" placeholder="Total Days * Amount" value="{{ old('medicines_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('drugs_date') }}">
        @error('drugs_date')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('drugs_from') }}">
        @error('drugs_from')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="drugs_to" name="drugs_to" placeholder="To" value="{{ old('drugs_to') }}">
        @error('drugs_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="drugs_total_days" name="drugs_total_days" placeholder="Total Days" value="{{ old('drugs_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="drugs_amount" name="drugs_amount" placeholder="Amount" value="{{ old('drugs_amount') }}">
        @error('drugs_amount')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="drugs_total_amount" name="drugs_total_amount" placeholder="Total Days * Amount" value="{{ old('drugs_total_amount') }}">
