<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('implants_for_surgical_procedures_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('implants_for_surgical_procedures_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="implants_for_surgical_procedures_to" name="implants_for_surgical_procedures_to" placeholder="To" value="{{ old('implants_for_surgical_procedures_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="implants_for_surgical_procedures_total_days" name="implants_for_surgical_procedures_total_days" placeholder="Total Days" value="{{ old('implants_for_surgical_procedures_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="implants_for_surgical_procedures_amount" name="implants_for_surgical_procedures_amount" placeholder="Amount" value="{{ old('implants_for_surgical_procedures_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="implants_for_surgical_procedures_total_amount" name="implants_for_surgical_procedures_total_amount" placeholder="Total Days * Amount" value="{{ old('implants_for_surgical_procedures_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('prosthetics_devices_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('prosthetics_devices_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="prosthetics_devices_to" name="prosthetics_devices_to" placeholder="To" value="{{ old('prosthetics_devices_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="prosthetics_devices_total_days" name="prosthetics_devices_total_days" placeholder="Total Days" value="{{ old('prosthetics_devices_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="prosthetics_devices_amount" name="prosthetics_devices_amount" placeholder="Amount" value="{{ old('prosthetics_devices_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="prosthetics_devices_total_amount" name="prosthetics_devices_total_amount" placeholder="Total Days * Amount" value="{{ old('prosthetics_devices_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('other_devices_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('other_devices_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="other_devices_to" name="other_devices_to" placeholder="To" value="{{ old('other_devices_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="other_devices_total_days" name="other_devices_total_days" placeholder="Total Days" value="{{ old('other_devices_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="other_devices_amount" name="other_devices_amount" placeholder="Amount" value="{{ old('other_devices_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="other_devices_total_amount" name="other_devices_total_amount" placeholder="Total Days * Amount" value="{{ old('other_devices_total_amount') }}">
