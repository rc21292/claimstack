<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('diagnostic_charges_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('diagnostic_charges_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="diagnostic_charges_to" name="diagnostic_charges_to" placeholder="To" value="{{ old('diagnostic_charges_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="diagnostic_charges_total_days" name="diagnostic_charges_total_days" placeholder="Total Days" value="{{ old('diagnostic_charges_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="diagnostic_charges_amount" name="diagnostic_charges_amount" placeholder="Amount" value="{{ old('diagnostic_charges_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="diagnostic_charges_total_amount" name="diagnostic_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('diagnostic_charges_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('lab_tests_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('lab_tests_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="lab_tests_to" name="lab_tests_to" placeholder="To" value="{{ old('lab_tests_to') }}">
        @error('lab_tests_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="lab_tests_total_days" name="lab_tests_total_days" placeholder="Total Days" value="{{ old('lab_tests_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="lab_tests_amount" name="lab_tests_amount" placeholder="Amount" value="{{ old('lab_tests_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="lab_tests_total_amount" name="lab_tests_total_amount" placeholder="Total Days * Amount" value="{{ old('lab_tests_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('investigation_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('investigation_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="investigation_to" name="investigation_to" placeholder="To" value="{{ old('investigation_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="investigation_total_days" name="investigation_total_days" placeholder="Total Days" value="{{ old('investigation_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="investigation_amount" name="investigation_amount" placeholder="Amount" value="{{ old('investigation_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="investigation_total_amount" name="investigation_total_amount" placeholder="Total Days * Amount" value="{{ old('investigation_total_amount') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="Date" value="{{ old('imaging_investigation_date') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        placeholder="From" value="{{ old('imaging_investigation_from') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="date" class="form-control" id="imaging_investigation_to" name="imaging_investigation_to" placeholder="To" value="{{ old('imaging_investigation_to') }}">
    ...
    <div class="col-md-3 mt-1">
        ...
        <input type="number" class="form-control" id="imaging_investigation_total_days" name="imaging_investigation_total_days" placeholder="Total Days" value="{{ old('imaging_investigation_total_days') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="imaging_investigation_amount" name="imaging_investigation_amount" placeholder="Amount" value="{{ old('imaging_investigation_amount') }}">
    ...
    <div class="col-md-4 mt-1">
        ...
        <input type="number" class="form-control" id="imaging_investigation_total_amount" name="imaging_investigation_total_amount" placeholder="Total Days * Amount" value="{{ old('imaging_investigation_total_amount') }}">
