<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('registration_admission_charges_date', $bill_entry->registration_admission_charges_date) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('registration_admission_charges_from', $bill_entry->registration_admission_charges_from) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="registration_admission_charges_to" name="registration_admission_charges_to" placeholder="To" value="{{ old('registration_admission_charges_to', $bill_entry->registration_admission_charges_to) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="registration_admission_charges_total_days" name="registration_admission_charges_total_days" placeholder="Total Days" value="{{ old('registration_admission_charges_total_days', $bill_entry->registration_admission_charges_total_days) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="registration_admission_charges_amount" name="registration_admission_charges_amount" placeholder="Amount" value="{{ old('registration_admission_charges_amount', $bill_entry->registration_admission_charges_amount) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="registration_admission_charges_total_amount" name="registration_admission_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('registration_admission_charges_total_amount', $bill_entry->registration_admission_charges_total_amount) }}">
