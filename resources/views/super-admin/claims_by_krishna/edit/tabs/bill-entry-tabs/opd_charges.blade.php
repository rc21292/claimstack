<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('opd_charges_date', $bill_entry->opd_charges_date) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('opd_charges_from', $bill_entry->opd_charges_from) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="opd_charges_to" name="opd_charges_to" placeholder="To" value="{{ old('opd_charges_to', $bill_entry->opd_charges_to) }}">
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="opd_charges_total_days" name="opd_charges_total_days" placeholder="Total Days" value="{{ old('opd_charges_total_days', $bill_entry->opd_charges_total_days) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="opd_charges_amount" name="opd_charges_amount" placeholder="Amount" value="{{ old('opd_charges_amount', $bill_entry->opd_charges_amount) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="opd_charges_total_amount" name="opd_charges_total_amount" placeholder="Total Days * Amount" value="{{ old('opd_charges_total_amount', $bill_entry->opd_charges_total_amount) }}">
...
<div class="form-group row">
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="Date" value="{{ old('wellness_date', $bill_entry->wellness_date) }}">
        @error('wellness_date')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-2">
        ...
        placeholder="From" value="{{ old('wellness_from', $bill_entry->wellness_from) }}">
        @error('wellness_from')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="date" class="form-control" id="wellness_to" name="wellness_to" placeholder="To" value="{{ old('wellness_to', $bill_entry->wellness_to) }}">
        @error('wellness_to')
        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-md-3 mt-2">
        ...
        <input type="number" class="form-control" id="wellness_total_days" name="wellness_total_days" placeholder="Total Days" value="{{ old('wellness_total_days', $bill_entry->wellness_total_days) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="wellness_amount" name="wellness_amount" placeholder="Amount" value="{{ old('wellness_amount', $bill_entry->wellness_amount) }}">
    ...
    <div class="col-md-4 mt-2">
        ...
        <input type="number" class="form-control" id="wellness_total_amount" name="wellness_total_amount" placeholder="Total Days * Amount" value="{{ old('wellness_total_amount', $bill_entry->wellness_total_amount) }}">
