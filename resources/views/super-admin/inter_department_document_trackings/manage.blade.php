...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="page-title-right">
                            <div class="input-group">
                                <div class="input-group-append">
                                    <a class="btn btn-primary" href="{{ route('super-admin.inter-department-docs-tracking.create') }}">Add Trcking</a>
                                </div>
                            </div>
                    </div>
            ...
            <div class="container">
                <form action="{{ route('super-admin.inter-department-docs-tracking.index') }}">
                                    ...
                                    <tbody>
                                        @foreach ($inter_department_document_trackings as $document_inward_outward_tracking)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('super-admin.inter-department-docs-tracking.edit', $document_inward_outward_tracking->id) }}"
                                                            class="btn btn-secondary"><i class="mdi mdi-pencil"></i></a>
                                                        <a href="{{ route('super-admin.inter-department-docs-tracking.show', $document_inward_outward_tracking->id) }}"
