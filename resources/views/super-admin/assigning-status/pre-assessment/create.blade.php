                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Assigning Status for Pre-Assessment</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="assessment_status_tab">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('super-admin.assigning-pre-assessment.update', $claim->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 text-end mt-3">
                                            <button @if($claim->assign_to) disabled @endif type="submit" class="btn btn-success"
                                                form="pre-assessment-assign-form">Assign for Pre-Assessment
                                                </button>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="hospital_name">Pre-Assessment Pending TAT <span
                                                    class="text-danger"></span></label>
                                            <input type="text" readonly class="form-control" id="hospital_name"
                                                name="hospital_name" placeholder="Enter Hospital Name"
                                                value="{{ $startDate->diff($endDate)->format('%D days : %H hours : %I minutes'); }}">
                                        ...
                                        <div class="col-md-12 text-end mt-3">
                                            <button type="submit" @if(!$claim->assign_to) disabled @endif  class="btn btn-success"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <select disabled class="form-select final_assessment_status"  id="final_assessment_status"
                                                ...
                                                {{ $claim->assessmentStatus->pre_assessment_status }}
                                                {{ $claim->assign_to}}
