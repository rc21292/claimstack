            ...
            <div class="col-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="assessment_status_tab">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('super-admin.assigning-final-assessment.update', $claim->id) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <select disabled class="form-select final_assessment_status"  id="final_assessment_status"
                                                ...
                                                <option>{{ $claim->assessmentStatus->final_assessment_status }}</option>
                                                @elseif($claim->assessmentStatus && empty($claim->assessmentStatus->final_assessment_status) && $claim->assign_to_assessment)
                                                <option></option>
                                                @else
