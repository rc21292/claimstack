                ...
                <div class="row pb-4">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select class="form-select" name="status">
                            ...
                            <option value="Waiting for Assigning Status for final Assessment" @if($filter_status == 'Waiting for Assigning Status for final Assessment') selected @endif> Waiting for Assigning Status for final Assessment</option>
