                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="associate_partner_details">
                                @include('super-admin.associate-partners.edit.tabs.associate-partner-details')
                            </div>
                            @if ($associate->type == 'vendor')
                                <div class="tab-pane" id="vendor_partner_service_type">
                                    @include('super-admin.associate-partners.edit.tabs.vendor-partner-service-type')
                                </div>
