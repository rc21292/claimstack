<form action="{{ route('super-admin.associate-partners.update', $associate->id) }}" method="post" id="associate-partner-form"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6 mt-1">
            <input type="text" class="form-control" onkeydown="return /[a-z, ]/i.test(event.key)"  id="owner_lastname" name="owner_lastname" maxlength="30"
        ...
        <div class="col-md-6 mt-3">
            ...
            <div class="input-group">
                <input type="text" class="form-control" id="pan" name="pan" maxlength="10" placeholder="Enter PAN no."
                    ...
                    @endisset
                    <input type="file" name="panfile" hidden id="panfile" onchange="$('label[for=' + $(this).attr('id') + ']').removeClass('btn-primary');$('label[for=' + $(this).attr('id') + ']').addClass('btn-warning');"/>
        ...
        <div class="col-md-6 mt-3">
            ...
            <select class="form-control select2 linked" id="linked_associate_partner" name="linked_associate_partner"
        ...
        <div class="col-md-6 mt-3">
            ...
            @error('agreement_end_date')
                <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
            @enderror
        <div id="agreement_end_date_error" style="color: red;"></div>
        </div>
        {{-- <div class="col-md-6 mt-3">
        ...
        <div class="col-md-12 mt-3">
            ...
            <textarea class="form-control" id="comments" name="comments" maxlength="1000" placeholder="Comments" rows="4">{{ old('comments', $associate->comments) }}</textarea>
            @error('comments')
                <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
