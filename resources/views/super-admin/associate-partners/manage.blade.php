            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('super-admin.associate-partners.index') }}">
                                    ...
                                    <tbody>
                                        @foreach ($associates as $associate)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('super-admin.associate-partners.edit', $associate->id) }}"
                                                            class="btn btn-primary"><i class="mdi mdi-pencil"></i></a>
                                                        <a href="{{ route('super-admin.associate-partners.show', $associate->id) }}"
                                                        ...
                                                        <form id='delete-form{{ $associate->id }}'
                                                            action='{{ route('super-admin.associate-partners.destroy', $associate->id) }}'
                                                            method='POST'>
