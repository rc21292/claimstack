                                    ...
                                    <tbody>
                                        @foreach ($hospitals as $hospital)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('super-admin.hospitals.edit', $hospital->id) }}"
                                                            class="btn btn-primary"><i class="mdi mdi-pencil"></i></a>
                                                        <a href="{{ route('super-admin.hospital-documents.show', $hospital->id) }}"
                                                        ...
                                                        <form id='delete-form{{ $hospital->id }}'
                                                            action='{{ route('super-admin.hospitals.destroy', $hospital->id) }}'
                                                            method='POST'>
