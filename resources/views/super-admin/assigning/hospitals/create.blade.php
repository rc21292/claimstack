                    ...
                    <div class="card-body">
                        <form action="{{ route('super-admin.assign-hospitals.update', $hospital->id) }}" method="post" id="hospital-form">
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <label for="assigned_linked_hospitals">Select Hospital Names <span
                                    class="text-danger">*</span></label>
                                    <select class="form-control select2" placeholder="Please Select Employee" multiple id="assigned_linked_hospitals" name="assigned_linked_hospitals[]"
                                    data-toggle="select2">
                                    <option value="">Select Employee</option>
                                    @foreach ($hospitals as $hospital)
                                    <option value="{{ $hospital->id }}"  @if(in_array($hospital->id, $selected_hospitals)) selected @endif >{{ $hospital->name }} [ {{ $hospital->uid }} ]</option>
                                    @endforeach
                                </select>
                                @error('assigned_linked_hospitals')
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <label for="assigned_linked_employees">Select Assigned Employee Names <span
                                    class="text-danger">*</span></label>
