            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('super-admin.hospital-tie-up-authorizations.index') }}">
                                    ...
                                    <tbody>
                                        @foreach ($hospitals_tie_ups as $hospitals_tie_up)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('super-admin.hospital-tie-up-authorizations.show', $hospitals_tie_up->id) }}"
                                                        ...
                                                        <form id='delete-form{{ $hospitals_tie_up->id }}'
                                                            action="{{ route('super-admin.hospital-tie-up-authorizations.update', $hospitals_tie_up->id) }}"
                                                            method='POST'>
