                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('super-admin.claimants.index') }}">Borrower</a>
                            </li>
        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills  bg-nav-pills  nav-justified mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('super-admin.borrowers.show', $claimant->id) }}" aria-expanded="true"
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="borrower_creation_tab">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('super-admin.borrowers.update', $claimant->id) }}" method="POST"
