                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="associate_partner_details">
                                @include('employee.associate-partners.edit.tabs.associate-partner-details')
                            </div>
                            @if ($associate->type == 'vendor')
                                <div class="tab-pane" id="vendor_partner_service_type">
                                    @include('employee.associate-partners.edit.tabs.vendor-partner-service-type')
                                </div>
                            ...
                            @else
                                ...
                                <div class="tab-pane" id="sub_sales_partner_status">
                                    @include('employee.associate-partners.edit.tabs.sub-sales-partner-status')
                                </div>
                                <div class="tab-pane" id="sales_partner_hospital_status">
                                    @include('employee.associate-partners.edit.tabs.sales-partner-hospital-status')
                                </div>
                                <div class="tab-pane" id="sales_partner_claim_status">
                                    @include('employee.associate-partners.edit.tabs.sales-partner-claim-status')
                                </div>
