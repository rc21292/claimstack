            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('employee.hospitals.index') }}">
                                    ...
                                    <tbody>
                                        @foreach ($hospitals as $hospital)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('employee.hospitals.edit', $hospital->id) }}"
                                                        ...
                                                        <form id='delete-form{{ $hospital->id }}'
                                                            action='{{ route('employee.hospitals.destroy', $hospital->id) }}'
                                                            method='POST'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="changePasswordForm" action="{{ route('employee.hospitals.change-password') }}">
                        @csrf
