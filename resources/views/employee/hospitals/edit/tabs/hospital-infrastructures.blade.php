<form action="{{ route('employee.hospitals.infrastructures', $hospital->id) }}" method="post" id="hospital-infrastructures-form"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-12 mt-3">
            ...
            <textarea class="form-control" id="comments" name="comments" maxlength="1000" placeholder="Comments" rows="4">{{ old('comments', $hospital_nfrastructure->comments??'') }}</textarea>
            @error('comments')
                <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
