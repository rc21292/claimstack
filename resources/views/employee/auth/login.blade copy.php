...
<html lang="en">
    <head>
        ...
        <meta content="A fully featured employee theme which can be used to build CRM, CMS, etc." name="description" />
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4">Welcome Employee !</p>
                                </div>
                                ...
                                <form action="{{ route('employee.login') }}" method="POST">
                                    ...
                                    <div class="form-group mb-3">
                                        <a href="{{ route('employee.password.request') }}" class="text-muted float-end"><small>Forgot your password?</small></a>
