        ...
        <div class="row">
            <div class="col-12">
                <div class="card no-shadow">
                    <div class="card-body">
                        <form action="{{ route('employee.users.update', $user->id) }}" method="post" id="userForm"
                            ...
                            <div class="form-group row">
                                    ...
                                    <select class="form-control select2" id="linked_employee" name="linked_employee"
                                        ...
                                        @foreach ($users as $row)
                                            <option value="{{ $row->id }}"
                                                ...
                                                data-id="{{ $row->employee_code }}">{{ $row->firstname }}
                                                {{ $row->lastname }} ({{ $row->employee_code }})</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    @include('employee.users.edit.permission')
                                </div>
