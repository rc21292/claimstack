    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="claims">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{ route('user.patients.index') }}">Patients</a>
                        </li>
                        <li>
                            <a href="{{ route('user.claims.index') }}">Claims</a>
                        </li>
                          <li>
                            <a href="{{ route('user.claims.index') }}">Claimants</a>
                        </li>
                    </ul>
                </div>
                @endif
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="settings">
                    <ul class="side-nav-second-level">
                        ...
                        <li>
                            <a href="{{ route('user.my-account.edit', Auth::guard('web')->id()) }}">My Profile</a>
                        </li>
                    </ul>
                </div>
            </li>
        ...
        <div class="help-box text-white text-center">
            ...
            <form id="sidebar-logout-form"
                action="{{ 'App\Models\Admin' == Auth::getProvider()->getModel() ? route('user.logout') : route('user.logout') }}"
