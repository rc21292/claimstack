        ...
        <div class="row">
            <div class="col-12">
                <div class="card no-shadow">
                    <div class="card-body">
                        <form action="{{ route('user.hospitals.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a class="btn btn-success" href="{{ route('user.hospitals.export') }}">Export Hospitals</a>
                        </form>
                    </div>
                </div>
            </div>
