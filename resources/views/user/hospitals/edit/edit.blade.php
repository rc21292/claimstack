                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="hospital_details">
                                @include('user.hospitals.edit.tabs.hospital-details')
                            </div>
                            <div class="tab-pane" id="hospital_tie_up_details">
                                @include('user.hospitals.edit.tabs.hospital-tie-up-details')
                            </div>
                            <div class="tab-pane" id="hospital_facilities">
                                @include('user.hospitals.edit.tabs.hospital-facilities')
                            </div>
                            <div class="tab-pane" id="hospital_infrastructures">
                                @include('user.hospitals.edit.tabs.hospital-infrastructures')
                            </div>
                            <div class="tab-pane" id="hospital_department">
                                @include('user.hospitals.edit.tabs.hospital-department')
                            </div>
                            ...
                            <div class="tab-pane" id="negative_isting">
                                @include('user.hospitals.edit.tabs.hospital-negative-listing-status')
                            </div>
                        </div>
                    </div>
                </div>
