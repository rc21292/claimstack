            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('user.hospitals.index') }}">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <form id='delete-form{{ $hospital->id }}'
                                                            action='{{ route('user.hospitals.destroy', $hospital->id) }}'
                                                            method='POST'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="changePasswordForm" action="{{ route('user.hospitals.change-password') }}">
                        @csrf
