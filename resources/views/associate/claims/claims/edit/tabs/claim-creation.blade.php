<form action="{{ route('associate-partner.claims.update', $claim->id) }}" method="post" id="claim-form"
           ...
           <div class="col-md-6 mt-3">
            ...
            <div class="col-md-6 mt-3">
                ...
                <select class="form-select" id="disease_category" name="disease_category">
                    ...
                    <option value="Cancer"
                        {{ old('disease_category', $claim->disease_category) == 'Cancer' ? 'selected' : '' }}>Cancer
                    </option>
                    <option value="Other"
            ...
            <div class="col-md-6 mt-3">
                ...
                <textarea maxlength="1000" style="height:30px;" class="form-control" id="disease_name" name="disease_name" placeholder="Disease Name">{{ old('disease_name', $claim->disease_name) }}</textarea>
                @error('disease_name')
                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="col-md-6 mt-3">
                ...
                <textarea maxlength="1000" class="form-control" id="ailment_details" name="ailment_details" style="height:30px;"  placeholder="Any other ailment details">{{ old('ailment_details', $claim->ailment_details) }}</textarea>
            ...
            <div class="col-md-12 text-end mt-3">
                <button type="submit" class="btn btn-success" disabled form="claim-form">Update Claim</button>
            </div>
    ...
    <div class="card-body show-hide-intimation" @if(old('insurance_coverage', $claim->insurance_coverage) != 'Yes') style="display:none;" @endif>
        <h4 class="page-title mb-2">Claim Intimation</h4>
         <form action="{{ route('associate-partner.claims.update', $claim->id) }}" method="post" id="claim-intimation-edit-form"
        enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="form-group row">
        ...
        <input type="hidden" name="form_type" value="claim-intimation-form">
            ...
            <div class="col-md-12 text-end mt-3">
                <button type="submit" class="btn btn-success" form="claim-intimation-edit-form" disabled>Update Intimation</button>
            </div>
        </div>
    </form>
    </div>
