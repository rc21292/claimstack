<div class="card-body">
    <form action="{{ route('associate-partner.claims.store') }}" method="post" id="claim-form" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6 mt-3">
                ...
                <select class="form-select" id="disease_category" name="disease_category">
                    ...
                    <option value="Cancer" {{ old('disease_category') == 'Cancer' ? 'selected' : '' }}>Cancer
                    </option>
