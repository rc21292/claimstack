                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('associate-partner.claims.index') }}">Claims</a>
                            </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card no-shadow">
                    <div class="card-body">
                        <form action="{{ route('associate-partner.claims.save_assesment_status') }}" method="post" id="claim-form" enctype="multipart/form-data">
                            @csrf
