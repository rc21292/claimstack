                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('associate-partner.claimants.index') }}">IC Claim Status</a>
                            </li>
            ...
            <div class="col-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="icclaim_status_tab">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('associate-partner.icclaim-status.update', $claimant->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <textarea class="form-control" id="ic_claim_status_comments" name="ic_claim_status_comments" maxlength="1000"
