                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('associate-partner.claimants.index') }}">Lending Status</a>
                            </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="lending_status_tab">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('associate-partner.lending-status.lending-status-update', $borrower->id) }}"
                                ...
                                <form action="{{ route('associate-partner.lending-status.lending-status-update', $borrower->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 text-end mt-3 mb-2">
                                            <button type="submit" disabled class="btn btn-success" form="loan-application-status-form">
