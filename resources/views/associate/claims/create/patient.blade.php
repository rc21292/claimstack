        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Insurance Policy Details</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card no-shadow">
                    <div class="card-body">
                        <form action="{{ route('associate-partner.patients.store') }}" method="post" id="hospital-form"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <textarea class="form-control" id="comments" name="comments" maxlength="1000" placeholder="Policy Details Comments" rows="4">{{ old('comments') }}</textarea>
                                    @error('comments')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
