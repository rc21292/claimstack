                    ...
                    <div class="card-body">
                        <form action="{{ route('associate-partner.patients.update', $patient->id) }}" method="post" id="hospital-form"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12 text-end mt-3">
                                    <button type="submit" disabled class="btn btn-success" form="hospital-form">Update
                                        Patient ID</button>
                                </div>
                            </div>
                        </form>
