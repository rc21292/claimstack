                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('associate-partner.patients.index') }}">Patient</a>
                            </li>
                ...
                <div class="card no-shadow">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="patient_edit_tab">
                            @include('associate.claims.patients.tabs.patient-edit')
                        </div>

                        <!-- <div class="tab-pane" id="documents_reimbursement_tab">
                            @include('associate.claims.patients.tabs.documents-reimbursement')
                        </div> -->
