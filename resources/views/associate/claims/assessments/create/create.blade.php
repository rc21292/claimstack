                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="assessment_status_tab">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('associate-partner.assessment-status.update-assessment-status', $claim->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 text-end mt-3">
                                            <button type="submit" class="btn btn-success"
                                                form="pre-assessment-status-form" disabled>Save / Update Pre-Assessment
                                                Status</button>
                                        </div>
                                    </div>
                                </form>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <textarea class="form-control" id="final_assessment_status_comments" name="final_assessment_status_comments"
                                                maxlength="1000" placeholder="Enter Final Assessment / Authorization Status Comments" rows="5">{{ old('final_assessment_status_comments', isset($assessment_status) ? $assessment_status->final_assessment_status_comments : '') }}</textarea>
