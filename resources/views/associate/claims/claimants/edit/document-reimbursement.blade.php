                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('associate-partner.claimants.index') }}">Claimant</a>
                            </li>
        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills  bg-nav-pills  nav-justified mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('associate-partner.document-reimbursement.show', $claimant->id) }}" aria-expanded="true"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('associate-partner.assessment-status.show', $claimant->id) }}" aria-expanded="false"
                            class="nav-link rounded-0">
                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                ...
                <div class="tab-content">                    
                    <div class="tab-pane show active" id="document_reimbursement_tab">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('associate-partner.document-reimbursement.update', $claimant->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <select class="form-control" id="title" name="title">
                                                ...
                                                <option disabled value="Mr."
                                                    {{ old('title', $claimant->patient->title) == 'Mr.' ? 'selected' : '' }}>
                                                    Mr.
                                                </option>
                                                <option disabled value="Ms."
                                                    {{ old('title', $claimant->patient->title) == 'Ms.' ? 'selected' : '' }}>
                                                    Ms.
                                                </option>
                                            </select>
                                            @error('title')
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <input type="text" readonly maxlength="25" class="form-control"
                                                ...
                                                value="{{ old('lastname', $claimant->patient->lastname) }}">
                                            @error('lastname')
                                                <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <input type="text" readonly maxlength="25" class="form-control"
                                                ...
                                                value="{{ old('firstname', $claimant->patient->firstname) }}">
                                            @error('firstname')
                                                <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <input type="text" readonly maxlength="25" class="form-control"
                                                ...
                                                value="{{ old('middlename', $claimant->patient->middlename) }}">
                                            @error('middlename')
                                                <span id="name-error"
                                                    class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
