                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('associate-partner.claimants.index') }}">Assessment Status</a>
                            </li>
        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-pills  bg-nav-pills  nav-justified mb-3">
                    <li class="nav-item">
                        <a href="{{ route('associate-partner.claimants.edit', $claimant->id) }}" aria-expanded="false"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('associate-partner.borrowers.show', $claimant->id) }}" aria-expanded="false"
                            class="nav-link rounded-0">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('associate-partner.lending-status.show', $claimant->id) }}" aria-expanded="false"
                            class="nav-link rounded-0">
                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('associate-partner.assessment-status.show', $claimant->id) }}" aria-expanded="true"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('associate-partner.discharge-status.show', $claimant->id) }}" aria-expanded="false"
                            class="nav-link rounded-0">
                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('associate-partner.claim-processing.show', $claimant->id) }}" aria-expanded="false"
                            class="nav-link rounded-0">
                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="assessment_status_tab">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('associate-partner.assessment-status.update', $claimant->id) }}"
