            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('associate-partner.claimants.index') }}">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><a class="dropdown-item" href="{{ route('associate-partner.claimants.edit', @$claimant->id) }}">
                                                                <i class="mdi mdi-pencil"></i> Edit Claimant</a>
                                                            </li>

                                                            @if(@$claimant->icclaim_status && !empty(@$claimant->icclaim_status))
                                                            <li><a class="dropdown-item" href="{{ route('associate-partner.icclaim-status.create', ['claimant_id' => $claimant->id]) }}">
