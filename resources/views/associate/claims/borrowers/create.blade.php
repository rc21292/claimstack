                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('associate-partner.claimants.index') }}">Borrowers</a>
                            </li>
            ...
            <div class="col-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="borrower_creation_tab">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('associate-partner.borrowers.borrowers-update', $claim->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 text-end mt-3">
                                            <button type="submit" disabled class="btn btn-success" form="borrower-details-form">
