            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('associate-partner.borrowers.index') }}">
                                                ...
                                                <td class="text-center">
                                                   <div class="input-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><a class="dropdown-item" href="{{ route('associate-partner.borrowers.edit', @$borrower->claim->id) }}">
                                                                <i class="mdi mdi-pencil"></i> Edit Borrower</a>
                                                            </li>

                                                            @if($borrower->lending_status && !empty($borrower->lending_status))
                                                            <li><a class="dropdown-item" href="{{ route('associate-partner.lending-status.create', ['borrower_id' => $borrower->id]) }}">
