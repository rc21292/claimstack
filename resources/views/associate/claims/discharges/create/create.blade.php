...
@section('title', 'New Discharge Status')
@section('content')
    <!-- Start Content-->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('associate-partner.claimants.index') }}">Discharge Status</a>
                            </li>
            ...
            <div class="col-12">
                <div class="tab-content">
                    <div class="tab-pane show active" id="lending_status_tab">
                        ...
                        <form action="{{ route('associate-partner.discharge-status.update-discharge-status', $claim->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" readonly class="form-control" id="hospital_id"
                                                name="hospital_id" maxlength="60" placeholder="Enter Hospital Id"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="insurance_coverage"
                                                ...
                                                <option value="Yes"
                                                    {{ old('insurance_coverage', $claim->insurance_coverage) == 'Yes' ? 'selected' : '' }}>
                                                    Yes
                                                </option>
                                                <option value="No"
                                                    {{ old('insurance_coverage', $claim->insurance_coverage) == 'No' ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="lending_required" name="lending_required" disabled>
                                                <option value="">Select</option>
                                                <option value="Yes"
                                                    {{ old('lending_required', $claim->lending_required) == 'Yes' ? 'selected' : '' }}>
                                                    Yes
                                                </option>
                                                <option value="No"
                                                    {{ old('lending_required', $claim->lending_required) == 'No' ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                            ...
                                            <div class="mt-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" disabled id="injury"
                                                        ...
                                                        @if (old('hospitalization_due_to', $claim->hospitalization_due_to) == 'Injury') checked @endif>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" disabled id="illness"
                                                        ...
                                                        @if (old('hospitalization_due_to', $claim->hospitalization_due_to) == 'Illness') checked @endif>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" disabled type="radio"
                                                        ...
                                                        @if (old('hospitalization_due_to', $claim->hospitalization_due_to) == 'Maternity') checked @endif>
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 text-end mt-3">
                                            <button disabled type="submit" class="btn btn-success" form="discharge-status-form">
