        ...
        <div class="row">
            <div class="col-12">
                <div class="card no-shadow">
                    <div class="card-body">
                        <form action="{{ route('associate-partner.hospitals.import') }}" method="POST" id="submit-form" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        <a href="{{ route('associate-partner.hospitals.export') }}" download="" class="btn btn-danger download-label"><i class="mdi mdi-download"></i> <br><span style="font-size: 18px;">Export Hospitals</span> </a>
