            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('associate-partner.hospitals.index') }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="changePasswordForm" action="{{ route('associate-partner.hospitals.change-password') }}">
                        @csrf
...
@endsection
{{-- @push('filter')
    @include('associate-partner.filters.question-filter')
@endpush --}}
@push('scripts')
