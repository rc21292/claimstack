            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <form action="{{ route('associate-partner.users.index') }}">
                                    ...
                                    <tbody>
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('associate-partner.users.edit', $user->id) }}"
                                                            class="btn btn-primary"><i class="mdi mdi-pencil"></i></a>
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="confirmDelete({{ $user->id }})"><i
                                                                class="uil uil-trash-alt"></i></button>
                                                        <form id='delete-form{{ $user->id }}'
                                                            action='{{ route('associate-partner.users.destroy', $user->id) }}'
                                                            method='POST'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="changePasswordForm" action="{{ route('associate-partner.users.change-password') }}">
                        @csrf
