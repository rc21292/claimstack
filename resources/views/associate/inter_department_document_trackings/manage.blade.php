                    ...
                    <div class="page-title-right">
                            <div class="input-group">
                                <div class="input-group-append">
                                    <a class="btn btn-primary" href="{{ route('associate-partner.inter-department-docs-tracking.create') }}">Add Trcking</a>
                                </div>
                            </div>
                    </div>
                    <h4 class="page-title">Manage Inter Department Document Tracking   </h4>
                </div>
            </div>

            <div class="container">
                <form action="{{ route('associate-partner.inter-department-docs-tracking.index') }}">
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-warning" href='./inter-department-docs-tracking' >Reset</a>
                        </div>
                ...
                <div class="card no-shadow">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                             @if (count($inter_department_document_trackings) > 0)
                                <table id="basics-datatable" class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($inter_department_document_trackings as $document_inward_outward_tracking)
                                            <tr>
                                                ...
                                                <td>{{ $document_inward_outward_tracking->hospital_id }}</td>
                                                <td>{{ $document_inward_outward_tracking->patient_id }}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('associate-partner.inter-department-docs-tracking.edit', $document_inward_outward_tracking->id) }}"
                                                            class="btn btn-secondary"><i class="mdi mdi-pencil"></i></a>
                                                        <a href="{{ route('associate-partner.inter-department-docs-tracking.show', $document_inward_outward_tracking->id) }}"
                        ...
                        {{ $inter_department_document_trackings->withQueryString()->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            </div>
        </div>
