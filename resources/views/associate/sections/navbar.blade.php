        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#"
                ...
                <span class="account-user-avatar">
                    <img @isset(Auth::guard('associate')->user()->avatar) src="{{asset('storage/uploads/associate/'.Auth::guard('associate')->user()->avatar) }}" @else src={{ asset('assets/images/users/avatar-1.jpg') }} @endisset alt="user-image" class="rounded-circle">
                </span>
                <span>
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                <!-- item-->
                <a href="{{ route('associate-partner.my-account.edit', Auth::guard('associate')->id()) }}"
