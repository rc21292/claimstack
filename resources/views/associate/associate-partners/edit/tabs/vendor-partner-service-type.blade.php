    ...
    <div class="form-group row">
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="cashless_claims_management" name="cashless_claims_management" onchange="changeCashlessManagement()">
                ...
                <option value="yes"
                    {{ old('cashless_claims_management',  isset($associate->service) ? $associate->service->cashless_claims_management : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('cashless_claims_management', isset($associate->service) ? $associate->service->cashless_claims_management : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_cashless_claims_management">
            <div class="input-group">
                ...
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="cashless_claims_management_charge"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="cashless_claims_management_comment" name="cashless_claims_management_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="cashless_helpdesk" name="cashless_helpdesk" onchange="changeCashlessHelpdesk()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('cashless_helpdesk', isset($associate->service) ? $associate->service->cashless_helpdesk : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('cashless_helpdesk', isset($associate->service) ? $associate->service->cashless_helpdesk : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_cashless_helpdesk">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="cashless_helpdesk_charge" name="cashless_helpdesk_charge"
                placeholder="Rs"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="cashless_helpdesk_comment" name="cashless_helpdesk_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="claims_assessment" name="claims_assessment" onchange="claimsAssessment()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('claims_assessment', isset($associate->service) ? $associate->service->claims_assessment : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('claims_assessment', isset($associate->service) ? $associate->service->claims_assessment : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_claims_assessment">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="claims_assessment_charge" name="claims_assessment_charge"
                placeholder="Rs"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="claims_assessment_comment" name="claims_assessment_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="claims_bill_entry" name="claims_bill_entry" onchange="changeClaimsBill()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('claims_bill_entry', isset($associate->service) ? $associate->service->claims_bill_entry : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('claims_bill_entry', isset($associate->service) ? $associate->service->claims_bill_entry : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_claims_bill_entry">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="claims_bill_entry_charge" name="claims_bill_entry_charge"
                placeholder="Rs"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="claims_bill_entry_comment" name="claims_bill_entry_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="claims_reimbursement" name="claims_reimbursement" onchange="claimsReimbursement()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('claims_reimbursement', isset($associate->service) ? $associate->service->claims_reimbursement : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('claims_reimbursement', isset($associate->service) ? $associate->service->claims_reimbursement : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_claims_reimbursement">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="claims_reimbursement_charge"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="claims_reimbursement_comment" name="claims_reimbursement_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="doctor_claim_process" name="doctor_claim_process" onchange="doctorClaimsProcess()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('doctor_claim_process', isset($associate->service) ? $associate->service->doctor_claim_process : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('doctor_claim_process', isset($associate->service) ? $associate->service->doctor_claim_process : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_doctor_claim_process">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="doctor_claim_process_charge"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="doctor_claim_process_comment" name="doctor_claim_process_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="doctor_honorary_panel" name="doctor_honorary_panel" onchange="doctorHonoraryPanel()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('doctor_honorary_panel', isset($associate->service) ? $associate->service->doctor_honorary_panel : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('doctor_honorary_panel', isset($associate->service) ? $associate->service->doctor_honorary_panel : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_doctor_honorary_panel">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="doctor_honorary_panel_charge"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="doctor_honorary_panel_comment" name="doctor_honorary_panel_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="doctor_tele_consultation" name="doctor_tele_consultation" onchange="doctorTeleConsultation()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('doctor_tele_consultation', isset($associate->service) ? $associate->service->doctor_tele_consultation : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('doctor_tele_consultation', isset($associate->service) ? $associate->service->doctor_tele_consultation : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_doctor_tele_consultation">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="doctor_tele_consultation_charge"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="doctor_tele_consultation_comment" name="doctor_tele_consultation_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="insurance_tpa_coordination" name="insurance_tpa_coordination" onchange="changeInsuranceTpa()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('insurance_tpa_coordination', isset($associate->service) ? $associate->service->insurance_tpa_coordination : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('insurance_tpa_coordination', isset($associate->service) ? $associate->service->insurance_tpa_coordination : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_insurance_tpa_coordination">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="insurance_tpa_coordination_charge"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="insurance_tpa_coordination_comment" name="insurance_tpa_coordination_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="medical_lending_bill" name="medical_lending_bill" onchange="medicalLendingBill()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('medical_lending_bill', isset($associate->service) ? $associate->service->medical_lending_bill : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('medical_lending_bill', isset($associate->service) ? $associate->service->medical_lending_bill : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_medical_lending_bill">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="medical_lending_bill_charge"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="medical_lending_bill_comment" name="medical_lending_bill_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1">
            <select class="form-select" id="medical_lending_patient" name="medical_lending_patient" onchange="medicalLendingPatient()">
                <option value="">Select</option>
                <option value="yes"
                    {{ old('medical_lending_patient', isset($associate->service) ? $associate->service->medical_lending_patient : '') == 'yes' ? 'selected' : 'disabled' }}>
                    Yes
                </option>
                <option value="no"
                    {{ old('medical_lending_patient', isset($associate->service) ? $associate->service->medical_lending_patient : '') == 'no' ? 'selected' : 'disabled' }}>
                    No
                </option>
            </select>
        ...
        <div class="col-md-6 mt-1 div_medical_lending_patient">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="medical_lending_patient_charge"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="medical_lending_patient_comment" name="medical_lending_patient_comment"
                placeholder="Comment"
        ...
        <div class="col-md-6 mt-1 div_others">
            <div class="input-group">
                <label class="input-group-text" for="phone">Rs.</label>
                <input type="number" onKeyPress="if(this.value.length==7) return false;" readonly class="form-control" id="others_charge" name="others_charge"
        ...
        <div class="col-md-12 mt-2">
            <input readonly type="text" class="form-control" maxlength="45" id="others_comment" name="others_comment"
                placeholder="Comment"
        ...
        <div class="col-md-12 mt-3">
            ...
            <textarea class="form-control" readonly id="vendor_partner_comments" name="vendor_partner_comments" placeholder="Write Comments here" rows="4">{{ old('vendor_partner_comments', isset($associate->service) ? $associate->service->vendor_partner_comments : '') }}</textarea>
